...
/* renamed from: me.tvspark.vs */
/* loaded from: classes4.dex */
public final class C2724vs implements AbstractC2086et {

    /* renamed from: me.tvspark.vs$Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww */
    /* loaded from: classes4.dex */
    ...
    /* renamed from: me.tvspark.vs$Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww */
    /* loaded from: classes4.dex */
    ...
    public Animator Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(@NonNull ViewGroup viewGroup, @NonNull View view) {
        ...
        return Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(view, alpha, 0.0f, 0.0f, 0.35f, alpha);
    }
    ...
    public Animator Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(@NonNull ViewGroup viewGroup, @NonNull View view) {
        float alpha = view.getAlpha() == 0.0f ? 1.0f : view.getAlpha();
        return Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(view, 0.0f, alpha, 0.35f, 1.0f, alpha);
    }
}
