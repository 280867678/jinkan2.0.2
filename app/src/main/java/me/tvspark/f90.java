...
public final class f90<T> extends l60<Boolean> implements n70<Boolean> {
    ...
    public f90(h60<T> h60Var, g70<? super T> g70Var) {
    ...
    public d60<Boolean> Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww() {
        return new e90(this.Wwwwwwwwwwwwwwwwwwwwwwww, this.Wwwwwwwwwwwwwwwwwwwwwww);
    }
}
