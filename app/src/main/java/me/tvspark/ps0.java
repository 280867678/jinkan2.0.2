...
public class ps0 implements View.OnClickListener {
    ...
    public ps0(DowningActivity downingActivity) {
    ...
    public void onClick(View view) {
        ...
        mn0.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(baseActivity, "", "", -1L, 5);
        this.Wwwwwwwwwwwwwwwwwwwwwwww.Wwwwwwwwwwwwww.dismiss();
    }
}
