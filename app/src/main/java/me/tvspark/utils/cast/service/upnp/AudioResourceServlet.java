...
public class AudioResourceServlet extends DefaultServlet {
    ...
    public Resource getResource(String str) {
        try {
            Cursor query = ApplicationC1880C.Wwwwwwwwwwwwwwwwwwwwwwww.getContentResolver().query(ContentUris.withAppendedId(MediaStore.Audio.Media.EXTERNAL_CONTENT_URI, Long.parseLong(r40.Wwwwwwwwwwwwwwwwwwwwwww(str))), null, null, null, null);
            query.moveToFirst();
