...
public class kp0 extends SetAVTransportURI {
    ...
    public kp0(ControlManager controlManager, UnsignedIntegerFourBytes unsignedIntegerFourBytes, Service service, String str, String str2, String str3, AbstractC3509oo0 abstractC3509oo0) {
    ...
    public void success(ActionInvocation actionInvocation) {
        VMLog.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("setAVTransportURI success %s", this.Wwwwwwwwwwwwwwwwwwwwwwww);
