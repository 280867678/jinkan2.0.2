...
public final class MediaControllerCompat {
    ...
    public static abstract class Callback implements IBinder.DeathRecipient {
        ...
        public static class StubApi21 implements MediaControllerCompatApi21.Callback {
            ...
            @Override // android.support.p000v4.media.session.MediaControllerCompatApi21.Callback
        ...
        public static class StubCompat extends IMediaControllerCallback.Stub {
            ...
            @Override // android.support.p000v4.media.session.IMediaControllerCallback
    ...
    public static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        public static class ExtraCallback extends Callback.StubCompat {
            ...
            @Override // android.support.p000v4.media.session.MediaControllerCompat.Callback.StubCompat, android.support.p000v4.media.session.IMediaControllerCallback
            public void onExtrasChanged(Bundle bundle) throws RemoteException {
        ...
        @Override // android.support.p000v4.media.session.MediaControllerCompat.MediaControllerImpl
    ...
    public static class MediaControllerImplApi23 extends MediaControllerImplApi21 {
        ...
        @Override // android.support.p000v4.media.session.MediaControllerCompat.MediaControllerImplApi21, android.support.p000v4.media.session.MediaControllerCompat.MediaControllerImpl
        public TransportControls getTransportControls() {
            Object transportControls = MediaControllerCompatApi21.getTransportControls(this.mControllerObj);
            if (transportControls != null) {
    ...
    public static class MediaControllerImplApi24 extends MediaControllerImplApi23 {
        ...
        @Override // android.support.p000v4.media.session.MediaControllerCompat.MediaControllerImplApi23, android.support.p000v4.media.session.MediaControllerCompat.MediaControllerImplApi21, android.support.p000v4.media.session.MediaControllerCompat.MediaControllerImpl
        public TransportControls getTransportControls() {
            Object transportControls = MediaControllerCompatApi21.getTransportControls(this.mControllerObj);
            if (transportControls != null) {
    ...
    public static class TransportControlsApi21 extends TransportControls {
        ...
        @Override // android.support.p000v4.media.session.MediaControllerCompat.TransportControls
    ...
    public static class TransportControlsApi23 extends TransportControlsApi21 {
        ...
        @Override // android.support.p000v4.media.session.MediaControllerCompat.TransportControlsApi21, android.support.p000v4.media.session.MediaControllerCompat.TransportControls
        public void playFromUri(Uri uri, Bundle bundle) {
    ...
    public MediaControllerCompat(Context context, @NonNull MediaSessionCompat.Token token) throws RemoteException {
        if (token != null) {
            ...
            this.mImpl = i >= 24 ? new MediaControllerImplApi24(context, token) : i >= 23 ? new MediaControllerImplApi23(context, token) : new MediaControllerImplApi21(context, token);
            return;
        }
    ...
    public MediaControllerCompat(Context context, @NonNull MediaSessionCompat mediaSessionCompat) {
        if (mediaSessionCompat != null) {
            ...
            try {
                mediaControllerImpl = Build.VERSION.SDK_INT >= 24 ? new MediaControllerImplApi24(context, sessionToken) : Build.VERSION.SDK_INT >= 23 ? new MediaControllerImplApi23(context, sessionToken) : new MediaControllerImplApi21(context, sessionToken);
            } catch (RemoteException unused) {
            }
    ...
    public static void validateCustomAction(String str, Bundle bundle) {
        ...
        throw new IllegalArgumentException(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("An extra field android.support.v4.media.session.ARGUMENT_MEDIA_ATTRIBUTE is required for this action ", str, "."));
    }
