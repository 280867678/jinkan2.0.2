...
public class C1410e {
    ...
    /* renamed from: c */
    public static Bitmap m2316c(String str) {
        try {
    ...
    /* renamed from: d */
    public static String m2315d(String str) {
        String str2;
        String substring = str.substring(str.lastIndexOf(".") + 1, str.length());
        if (TextUtils.isEmpty(substring)) {
            return "*/*";
        }
        String Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(".", substring);
        int i = 0;
        while (true) {
            ...
            if (i >= strArr.length) {
                str2 = "*/*";
                break;
            } else if (Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.equalsIgnoreCase(strArr[i][0])) {
                str2 = f2291a[i][1];
                break;
            } else {
                i++;
