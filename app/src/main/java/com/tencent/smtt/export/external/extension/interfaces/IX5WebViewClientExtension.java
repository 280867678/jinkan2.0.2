...
public interface IX5WebViewClientExtension {
    ...
    void onReportMemoryCachedResponse(String str, int i, HashMap<String, String> hashMap);

    void onReportResponseHeaders(String str, int i, HashMap<String, String> hashMap);
