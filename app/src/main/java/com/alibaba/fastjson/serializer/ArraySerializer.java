        ...
        if (obj instanceof boolean[]) {
            ...
            while (i < length) {
                ...
                if (Double.isNaN(d)) {
                    ...
                    serializeWriter.mo4402append((CharSequence) Double.toString(d));
                }
                serializeWriter.write(44);
                i++;
            }
            ...
            if (Double.isNaN(d2)) {
                ...
                serializeWriter.mo4402append((CharSequence) Double.toString(d2));
            }
            serializeWriter.write(93);
            ...
            while (i < length2) {
                ...
                if (Float.isNaN(f)) {
                    ...
                    serializeWriter.mo4402append((CharSequence) Float.toString(f));
                }
                serializeWriter.write(44);
                i++;
            }
            ...
            if (Float.isNaN(f2)) {
                ...
                serializeWriter.mo4402append((CharSequence) Float.toString(f2));
            }
            serializeWriter.write(93);
            ...
            try {
                ...
                while (i < length3) {
                    ...
                    if (obj3 != null) {
                        ...
                        objectSerializer.write(jSONSerializer, obj3, valueOf, null);
