...
public class StatTracer implements AbstractC1798b {
    ...
    public static class C1794a {
        ...
        /* renamed from: a */
        public static final StatTracer f4119a = new StatTracer();
    }
    ...
    public static StatTracer getInstance(Context context) {
        if (mContext == null) {
            if (context != null) {
                ...
                MLog.m574e("inside StatTracer. please check context. context must not be null!");
            }
        }
        return C1794a.f4119a;
    }
    ...
    @Override // com.umeng.commonsdk.statistics.internal.AbstractC1798b
