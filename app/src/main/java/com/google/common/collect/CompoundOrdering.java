...
public final class CompoundOrdering<T> extends Ordering<T> implements Serializable {
    ...
    public CompoundOrdering(Iterable<? extends Comparator<? super T>> iterable) {
        this.comparators = (Comparator[]) Illllllllllllllllllllllllllll.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww((Iterable) iterable, (Object[]) new Comparator[0]);
    }
    ...
    public String toString() {
        return outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Ordering.compound("), Arrays.toString(this.comparators), ")");
    }
}
