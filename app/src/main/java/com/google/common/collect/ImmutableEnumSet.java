...
public final class ImmutableEnumSet<E extends Enum<E>> extends ImmutableSet<E> {
    ...
    public static ImmutableSet asImmutable(EnumSet enumSet) {
        ...
        return size != 0 ? size != 1 ? new ImmutableEnumSet(enumSet) : ImmutableSet.m3876of(Illllllllllllllllllllllllllll.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww((Iterable<Object>) enumSet)) : ImmutableSet.m3877of();
    }
    ...
    public AbstractC2239iy<E> mo4735iterator() {
        return Illllllllllllllllllllllllllll.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwww(this.delegate.iterator());
    }
