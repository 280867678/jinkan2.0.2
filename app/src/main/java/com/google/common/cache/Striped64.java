...
public abstract class Striped64 extends Number {
    ...
    /* renamed from: fn */
    public abstract long mo3929fn(long j, long j2);
        ...
        while (true) {
            ...
            if (wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwArr != null && (length = wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwArr.length) > 0) {
                ...
                if (wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww == null) {
                    ...
                    if (wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(j2, mo3929fn(j2, j))) {
                        return;
                    }
