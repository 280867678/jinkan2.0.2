...
public class AtomicDoubleArray implements Serializable {
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        ...
        ImmutableLongArray.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww builder = ImmutableLongArray.builder();
        ...
        this.longs = new AtomicLongArray(builder.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww().toArray());
    }
