...
public abstract class HashCode {
    ...
    public static final class BytesHashCode extends HashCode implements Serializable {
        ...
        @Override // com.google.common.hash.HashCode
        public int asInt() {
            Illllllllllllllllllllllllllll.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(this.bytes.length >= 4, "HashCode#asInt() requires >= 4 bytes (it only has %s bytes).", this.bytes.length);
        ...
        @Override // com.google.common.hash.HashCode
        public long asLong() {
            Illllllllllllllllllllllllllll.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(this.bytes.length >= 8, "HashCode#asLong() requires >= 8 bytes (it only has %s bytes).", this.bytes.length);
            return padToLong();
        }
    ...
    public static final class IntHashCode extends HashCode implements Serializable {
        ...
        @Override // com.google.common.hash.HashCode
        public long padToLong() {
            return Illllllllllllllllllllllllllll.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwww(this.hash);
        }
    ...
    public static HashCode fromBytes(byte[] bArr) {
        ...
        Illllllllllllllllllllllllllll.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(z, "A HashCode must contain at least 1 byte.");
    ...
    public static HashCode fromString(String str) {
        boolean z = true;
        Illllllllllllllllllllllllllll.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(str.length() >= 2, "input string (%s) must have at least 2 characters", str);
        if (str.length() % 2 != 0) {
            z = false;
        }
        Illllllllllllllllllllllllllll.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(z, "input string (%s) must have an even number of characters", str);
    ...
    public int writeBytesTo(byte[] bArr, int i, int i2) {
        int[] iArr = {i2, bits() / 8};
        Illllllllllllllllllllllllllll.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(true);
        int i3 = iArr[0];
        ...
        Illllllllllllllllllllllllllll.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(i, i + i3, bArr.length);
