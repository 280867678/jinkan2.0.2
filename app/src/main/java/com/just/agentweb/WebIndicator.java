...
public class WebIndicator extends BaseIndicatorView implements BaseIndicatorSpec {
    ...
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("CURRENT_MAX_UNIFORM_SPEED_DURATION");
        Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(this.mCurrentMaxUniformSpeedDuration);
        LogUtils.m3701i("WebProgress", Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.toString());
    }
