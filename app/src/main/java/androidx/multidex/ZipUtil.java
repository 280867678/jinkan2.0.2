...
public final class ZipUtil {
    ...
    public static CentralDirectory findCentralDirectory(RandomAccessFile randomAccessFile) throws IOException, ZipException {
        ...
        long j = 0;
        if (length < 0) {
            StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("File too short to be a zip file: ");
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(randomAccessFile.length());
            throw new ZipException(Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.toString());
        }
