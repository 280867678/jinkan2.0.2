...
public class RoundRectDrawableWithShadow extends Drawable {
    ...
    public final RectF mCardBounds = new RectF();
    ...
    public RoundRectDrawableWithShadow(Resources resources, ColorStateList colorStateList, float f, float f2, float f3) {
        this.mShadowStartColor = resources.getColor(C0155R.color.cardview_shadow_start_color);
        this.mShadowEndColor = resources.getColor(C0155R.color.cardview_shadow_end_color);
        this.mInsetShadow = resources.getDimensionPixelSize(C0155R.dimen.cardview_compat_inset_shadow);
    ...
    public static float calculateVerticalPadding(float f, float f2, boolean z) {
        float f3 = f * 1.5f;
        if (z) {
            return (float) (((1.0d - COS_45) * f2) + f3);
        }
        return f3;
    }
    ...
    public float getMinHeight() {
        ...
        return (((this.mRawMaxShadowSize * 1.5f) + this.mInsetShadow) * 2.0f) + (Math.max(f, f2 + this.mCornerRadius + this.mInsetShadow) * 2.0f);
    }

    public float getMinWidth() {
        float f = this.mRawMaxShadowSize;
        float f2 = f / 2.0f;
        return ((this.mRawMaxShadowSize + this.mInsetShadow) * 2.0f) + (Math.max(f, f2 + this.mCornerRadius + this.mInsetShadow) * 2.0f);
    }
