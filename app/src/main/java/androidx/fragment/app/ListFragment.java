...
public class ListFragment extends Fragment {
    ...
    public final Runnable mRequestFocus = new Runnable() { // from class: androidx.fragment.app.ListFragment.1
    ...
    private void setListShown(boolean z, boolean z2) {
        ...
        if (view != null) {
            ...
            if (z) {
                if (z2) {
                    view.startAnimation(AnimationUtils.loadAnimation(mo4928getContext(), 17432577));
                    this.mListContainer.startAnimation(AnimationUtils.loadAnimation(mo4928getContext(), 17432576));
                } else {
                    view.clearAnimation();
            ...
            if (z2) {
                view.startAnimation(AnimationUtils.loadAnimation(mo4928getContext(), 17432576));
                this.mListContainer.startAnimation(AnimationUtils.loadAnimation(mo4928getContext(), 17432577));
            } else {
                view.clearAnimation();
                this.mListContainer.clearAnimation();
            }
