...
public abstract class FragmentTransaction {
    ...
    /* loaded from: classes3.dex */
    public static final class C0354Op {
        public int mCmd;
        ...
        public C0354Op(int i, Fragment fragment) {
            this.mCmd = i;
        ...
        public C0354Op(int i, @NonNull Fragment fragment, Lifecycle.State state) {
            this.mCmd = i;
            this.mFragment = fragment;
    ...
    public void addOp(C0354Op c0354Op) {
        this.mOps.add(c0354Op);
        c0354Op.mEnterAnim = this.mEnterAnim;
        c0354Op.mExitAnim = this.mExitAnim;
        c0354Op.mPopEnterAnim = this.mPopEnterAnim;
        c0354Op.mPopExitAnim = this.mPopExitAnim;
    }
    ...
    public FragmentTransaction addSharedElement(@NonNull View view, @NonNull String str) {
        if (FragmentTransition.supportsTransition()) {
            ...
            if (this.mSharedElementSourceNames == null) {
                ...
                throw new IllegalArgumentException(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("A shared element with the target name '", str, "' has already been added to the transaction."));
            } else {
                if (this.mSharedElementSourceNames.contains(transitionName)) {
                    throw new IllegalArgumentException(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("A shared element with the source name '", transitionName, "' has already been added to the transaction."));
                }
            }
    ...
    public void doAddOp(int i, Fragment fragment, @Nullable String str, int i2) {
        ...
        if (cls.isAnonymousClass() || !Modifier.isPublic(modifiers) || (cls.isMemberClass() && !Modifier.isStatic(modifiers))) {
            ...
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(cls.getCanonicalName());
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(" must be a public static class to be  properly recreated from instance state.");
        ...
        if (str != null) {
            ...
            if (str2 != null && !str.equals(str2)) {
                ...
                sb.append(fragment);
                sb.append(": was ");
                throw new IllegalStateException(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(sb, fragment.mTag, " now ", str));
            }
            fragment.mTag = str;
        }
        if (i != 0) {
        ...
        addOp(new C0354Op(i2, fragment));
    }

    @NonNull
    public FragmentTransaction hide(@NonNull Fragment fragment) {
        addOp(new C0354Op(4, fragment));
        return this;
    }
    ...
    public FragmentTransaction setMaxLifecycle(@NonNull Fragment fragment, @NonNull Lifecycle.State state) {
        addOp(new C0354Op(10, fragment, state));
        return this;
    }

    @NonNull
    public FragmentTransaction setPrimaryNavigationFragment(@Nullable Fragment fragment) {
        addOp(new C0354Op(8, fragment));
        return this;
    }
