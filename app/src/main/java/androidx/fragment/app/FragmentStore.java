        ...
        if (!this.mActive.isEmpty()) {
            ...
            for (FragmentStateManager fragmentStateManager : this.mActive.values()) {
                ...
                if (fragmentStateManager != null) {
                    ...
                    fragment.dump(Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww, fileDescriptor, printWriter, strArr);
                } else {
        ...
        if (list != null) {
            for (String str : list) {
                ...
                if (findActiveFragment == null) {
                    throw new IllegalStateException(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("No instantiated fragment for (", str, ")"));
                }
                if (FragmentManager.isLoggingEnabled(2)) {
