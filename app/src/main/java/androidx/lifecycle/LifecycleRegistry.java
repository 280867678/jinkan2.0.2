...
public class LifecycleRegistry extends Lifecycle {
    ...
    private void backwardPass(LifecycleOwner lifecycleOwner) {
        ...
        while (descendingIterator.hasNext() && !this.mNewEventOccurred) {
            ...
            while (value.mState.compareTo(this.mState) > 0 && !this.mNewEventOccurred && this.mObserverMap.contains(next.getKey())) {
                ...
                if (downFrom == null) {
                    StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("no event down from ");
                    Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(value.mState);
    ...
    private void enforceMainThreadIfNeeded(String str) {
        ...
        throw new IllegalStateException(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Method ", str, " must be called on the main thread"));
    }
    ...
    private void forwardPass(LifecycleOwner lifecycleOwner) {
        ...
        while (iteratorWithAdditions.hasNext() && !this.mNewEventOccurred) {
            ...
            while (observerWithState.mState.compareTo(this.mState) < 0 && !this.mNewEventOccurred && this.mObserverMap.contains(next.getKey())) {
                ...
                if (upFrom == null) {
                    StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("no event up from ");
                    Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(observerWithState.mState);
                    throw new IllegalStateException(Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.toString());
                }
