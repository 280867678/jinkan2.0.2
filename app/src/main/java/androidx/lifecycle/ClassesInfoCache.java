...
public final class ClassesInfoCache {
    ...
    private void verifyAndPutHandler(Map<MethodReference, Lifecycle.Event> map, MethodReference methodReference, Lifecycle.Event event, Class<?> cls) {
        ...
        StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Method ");
        ...
        Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(" already declared with different @OnLifecycleEvent value: previous value ");
        Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(event2);
        Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(", new value ");
        Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(event);
