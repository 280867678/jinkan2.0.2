...
public final class DisplayCutoutCompat {
    ...
    public String toString() {
        StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("DisplayCutoutCompat{");
        Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(this.mDisplayCutout);
