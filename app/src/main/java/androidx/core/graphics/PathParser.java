...
public class PathParser {
    ...
    public static class PathDataNode {
        ...
        public static void drawArc(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            ...
            int i = (atan22 > RoundRectDrawableWithShadow.COS_45 ? 1 : (atan22 == RoundRectDrawableWithShadow.COS_45 ? 0 : -1));
            if (z2 != (i >= 0)) {
    ...
    public static Path createPathFromPathData(String str) {
        ...
        if (createNodesFromPathData != null) {
            try {
                ...
                throw new RuntimeException(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Error in parsing ", str), e);
            }
        }
        return null;
    }
