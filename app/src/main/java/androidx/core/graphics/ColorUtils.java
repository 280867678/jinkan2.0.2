...
public final class ColorUtils {
    ...
    @ColorInt
    public static int LABToColor(@FloatRange(from = 0.0d, m4213to = 100.0d) double d, @FloatRange(from = -128.0d, m4213to = 127.0d) double d2, @FloatRange(from = -128.0d, m4213to = 127.0d) double d3) {
        double[] tempDouble3Array = getTempDouble3Array();
        LABToXYZ(d, d2, d3, tempDouble3Array);
        return XYZToColor(tempDouble3Array[0], tempDouble3Array[1], tempDouble3Array[2]);
    }

    public static void LABToXYZ(@FloatRange(from = 0.0d, m4213to = 100.0d) double d, @FloatRange(from = -128.0d, m4213to = 127.0d) double d2, @FloatRange(from = -128.0d, m4213to = 127.0d) double d3, @NonNull double[] dArr) {
    ...
    public static void RGBToHSL(@IntRange(from = 0, m4212to = 255) int i, @IntRange(from = 0, m4212to = 255) int i2, @IntRange(from = 0, m4212to = 255) int i3, @NonNull float[] fArr) {
        float f;
        float abs;
        float f2 = i / 255.0f;
        float f3 = i2 / 255.0f;
    ...
    public static void RGBToLAB(@IntRange(from = 0, m4212to = 255) int i, @IntRange(from = 0, m4212to = 255) int i2, @IntRange(from = 0, m4212to = 255) int i3, @NonNull double[] dArr) {
        RGBToXYZ(i, i2, i3, dArr);
        XYZToLAB(dArr[0], dArr[1], dArr[2], dArr);
    }

    public static void RGBToXYZ(@IntRange(from = 0, m4212to = 255) int i, @IntRange(from = 0, m4212to = 255) int i2, @IntRange(from = 0, m4212to = 255) int i3, @NonNull double[] dArr) {
        if (dArr.length == 3) {
            double d = i / 255.0d;
    ...
    @ColorInt
    public static int XYZToColor(@FloatRange(from = 0.0d, m4213to = 95.047d) double d, @FloatRange(from = 0.0d, m4213to = 100.0d) double d2, @FloatRange(from = 0.0d, m4213to = 108.883d) double d3) {
    ...
    public static void XYZToLAB(@FloatRange(from = 0.0d, m4213to = 95.047d) double d, @FloatRange(from = 0.0d, m4213to = 100.0d) double d2, @FloatRange(from = 0.0d, m4213to = 108.883d) double d3, @NonNull double[] dArr) {
        if (dArr.length == 3) {
            ...
            dArr[0] = Math.max((double) RoundRectDrawableWithShadow.COS_45, (116.0d * pivotXyzComponent2) - 16.0d);
    ...
    @ColorInt
    public static int blendARGB(@ColorInt int i, @ColorInt int i2, @FloatRange(from = 0.0d, m4213to = 1.0d) float f) {
        float f2 = 1.0f - f;
        return Color.argb((int) ((Color.alpha(i2) * f) + (Color.alpha(i) * f2)), (int) ((Color.red(i2) * f) + (Color.red(i) * f2)), (int) ((Color.green(i2) * f) + (Color.green(i) * f2)), (int) ((Color.blue(i2) * f) + (Color.blue(i) * f2)));
    }

    public static void blendHSL(@NonNull float[] fArr, @NonNull float[] fArr2, @FloatRange(from = 0.0d, m4213to = 1.0d) float f, @NonNull float[] fArr3) {
        if (fArr3.length == 3) {
            float f2 = 1.0f - f;
    ...
    public static void blendLAB(@NonNull double[] dArr, @NonNull double[] dArr2, @FloatRange(from = 0.0d, m4213to = 1.0d) double d, @NonNull double[] dArr3) {
        if (dArr3.length == 3) {
            double d2 = 1.0d - d;
    ...
    public static double calculateContrast(@ColorInt int i, @ColorInt int i2) {
        if (Color.alpha(i2) != 255) {
            StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("background can not be translucent: #");
    ...
    public static Color compositeColors(@NonNull Color color, @NonNull Color color2) {
        if (!Objects.equals(color.getModel(), color2.getModel())) {
            StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Color models must match (");
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(color.getModel());
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(" vs. ");
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(color2.getModel());
    ...
    @ColorInt
    public static int setAlphaComponent(@ColorInt int i, @IntRange(from = 0, m4212to = 255) int i2) {
        if (i2 < 0 || i2 > 255) {
