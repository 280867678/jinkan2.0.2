...
public final class TimeUtils {
    ...
    public static void formatDuration(long j, long j2, PrintWriter printWriter) {
        if (j == 0) {
            printWriter.print(MultiPartWriter.__DASHDASH);
        } else {
    ...
    public static int formatDurationLocked(long j, int i) {
        ...
        if (i != 0) {
            ...
            int accumField2 = accumField(i3, 1, accumField > 0, 2) + accumField;
            int accumField3 = accumField(i5, 1, accumField2 > 0, 2) + accumField2;
            int accumField4 = accumField(i4, 1, accumField3 > 0, 2) + accumField3;
            i6 = 0;
            for (int accumField5 = accumField(i9, 2, true, accumField4 > 0 ? 3 : 0) + 1 + accumField4; accumField5 < i; accumField5++) {
                cArr[i6] = TokenParser.f4579SP;
                i6++;
            }
        } else {
            i6 = 0;
