...
public final class LinkifyCompat {
            ...
            try {
                ...
                if (findAddress != null && (indexOf = obj.indexOf(findAddress)) >= 0) {
                    ...
                    try {
                        ...
                        linkSpec.url = com.tencent.smtt.sdk.WebView.SCHEME_GEO + encode;
                        arrayList.add(linkSpec);
    ...
    public static String makeUrl(@NonNull String str, @NonNull String[] strArr, Matcher matcher, @Nullable Linkify.TransformFilter transformFilter) {
        ...
        return (z || strArr.length <= 0) ? str : outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(new StringBuilder(), strArr[0], str);
    }
