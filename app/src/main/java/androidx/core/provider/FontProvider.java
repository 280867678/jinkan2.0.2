    ...
    public static ProviderInfo getProvider(@NonNull PackageManager packageManager, @NonNull FontRequest fontRequest, @Nullable Resources resources) throws PackageManager.NameNotFoundException {
        ...
        if (resolveContentProvider != null) {
            if (!resolveContentProvider.packageName.equals(fontRequest.getProviderPackage())) {
                StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Found content provider ", providerAuthority, ", but package was not ");
                Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(fontRequest.getProviderPackage());
                throw new PackageManager.NameNotFoundException(Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.toString());
            }
        ...
        throw new PackageManager.NameNotFoundException(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("No package found for authority: ", providerAuthority));
    }
