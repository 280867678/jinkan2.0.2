...
public final class TextViewOnReceiveContentListener implements OnReceiveContentListener {
    ...
    @NonNull
    public static CharSequence coerceToText(@NonNull ClipData clipData, @NonNull Context context, int i) {
    ...
    public static void onReceiveForDragAndDrop(@NonNull TextView textView, @NonNull ContentInfoCompat contentInfoCompat) {
