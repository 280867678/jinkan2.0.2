...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            @NonNull
            /* renamed from: clone */
            public WearableExtender m4307clone() {
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(@Nullable Bitmap bitmap) {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0196R.dimen.compat_notification_large_icon_max_width);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0196R.dimen.compat_notification_large_icon_max_height);
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            ...
            boolean z2 = true;
            int i = 0;
            RemoteViews applyStandardTemplate = applyStandardTemplate(true, C0196R.layout.notification_template_custom_big, false);
            applyStandardTemplate.removeAllViews(C0196R.C0198id.actions);
            ...
            if (!z || nonContextualActions == null || (min = Math.min(nonContextualActions.size(), 3)) <= 0) {
                ...
                for (int i2 = 0; i2 < min; i2++) {
                    applyStandardTemplate.addView(C0196R.C0198id.actions, generateActionButton(nonContextualActions.get(i2)));
                }
            }
            if (!z2) {
                i = 8;
            }
            applyStandardTemplate.setViewVisibility(C0196R.C0198id.actions, i);
            applyStandardTemplate.setViewVisibility(C0196R.C0198id.action_divider, i);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), z ? C0196R.layout.notification_action_tombstone : C0196R.layout.notification_action);
            IconCompat iconCompat = action.getIconCompat();
            if (iconCompat != null) {
                remoteViews.setImageViewBitmap(C0196R.C0198id.action_image, createColoredBitmap(iconCompat, this.mBuilder.mContext.getResources().getColor(C0196R.color.notification_action_color_filter)));
            }
            remoteViews.setTextViewText(C0196R.C0198id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0196R.C0198id.action_container, action.actionIntent);
            }
            remoteViews.setContentDescription(C0196R.C0198id.action_container, action.title);
            return remoteViews;
        }
    ...
    public static class MessagingStyle extends Style {
        ...
        */
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            new Notification.BigTextStyle(notificationBuilderWithBuilderAccessor.getBuilder()).setBigContentTitle(null).bigText(spannableStringBuilder2);
        }
    ...
    public static abstract class Style {
        ...
        private int calculateTopPadding() {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0196R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0196R.dimen.notification_top_pad_large_text);
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0196R.C0197drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0196R.C0198id.title, 8);
            remoteViews.setViewVisibility(C0196R.C0198id.text2, 8);
            remoteViews.setViewVisibility(C0196R.C0198id.text, 8);
        }
        ...
        */
        public RemoteViews applyStandardTemplate(boolean z, int i, boolean z2) {
            ...
            if (builder.mLargeIcon != null) {
                remoteViews.setViewVisibility(C0196R.C0198id.icon, 0);
                remoteViews.setImageViewBitmap(C0196R.C0198id.icon, this.mBuilder.mLargeIcon);
                if (z && this.mBuilder.mNotification.icon != 0) {
                    int dimensionPixelSize = resources.getDimensionPixelSize(C0196R.dimen.notification_right_icon_size);
                    Builder builder2 = this.mBuilder;
                    remoteViews.setImageViewBitmap(C0196R.C0198id.right_icon, createIconWithBackground(builder2.mNotification.icon, dimensionPixelSize, dimensionPixelSize - (resources.getDimensionPixelSize(C0196R.dimen.notification_small_icon_background_padding) * 2), builder2.getColor()));
                    remoteViews.setViewVisibility(C0196R.C0198id.right_icon, 0);
                }
            } else if (z && builder.mNotification.icon != 0) {
                remoteViews.setViewVisibility(C0196R.C0198id.icon, 0);
                int dimensionPixelSize2 = resources.getDimensionPixelSize(C0196R.dimen.notification_large_icon_width) - resources.getDimensionPixelSize(C0196R.dimen.notification_big_circle_margin);
                int dimensionPixelSize3 = resources.getDimensionPixelSize(C0196R.dimen.notification_small_icon_size_as_large);
                Builder builder3 = this.mBuilder;
                remoteViews.setImageViewBitmap(C0196R.C0198id.icon, createIconWithBackground(builder3.mNotification.icon, dimensionPixelSize2, dimensionPixelSize3, builder3.getColor()));
            }
            CharSequence charSequence2 = this.mBuilder.mContentTitle;
            if (charSequence2 != null) {
                remoteViews.setTextViewText(C0196R.C0198id.title, charSequence2);
            }
            CharSequence charSequence3 = this.mBuilder.mContentText;
            boolean z6 = true;
            if (charSequence3 != null) {
                remoteViews.setTextViewText(C0196R.C0198id.text, charSequence3);
                z3 = true;
            } else {
                z3 = false;
            }
            ...
            if (charSequence4 != null) {
                remoteViews.setTextViewText(C0196R.C0198id.info, charSequence4);
            } else if (builder4.mNumber <= 0) {
                remoteViews.setViewVisibility(C0196R.C0198id.info, 8);
                z4 = false;
                charSequence = this.mBuilder.mSubText;
                if (charSequence != null) {
                    remoteViews.setTextViewText(C0196R.C0198id.text, charSequence);
                    CharSequence charSequence5 = this.mBuilder.mContentText;
                    if (charSequence5 != null) {
                        remoteViews.setTextViewText(C0196R.C0198id.text2, charSequence5);
                        remoteViews.setViewVisibility(C0196R.C0198id.text2, 0);
                        z5 = true;
                        if (z5) {
                            if (z2) {
                                remoteViews.setTextViewTextSize(C0196R.C0198id.text, 0, resources.getDimensionPixelSize(C0196R.dimen.notification_subtext_size));
                            }
                            remoteViews.setViewPadding(C0196R.C0198id.line1, 0, 0, 0, 0);
                        }
                        if (this.mBuilder.getWhenIfShowing() == 0) {
                            z6 = z4;
                        } else if (this.mBuilder.mUseChronometer) {
                            remoteViews.setViewVisibility(C0196R.C0198id.chronometer, 0);
                            remoteViews.setLong(C0196R.C0198id.chronometer, "setBase", (SystemClock.elapsedRealtime() - System.currentTimeMillis()) + this.mBuilder.getWhenIfShowing());
                            remoteViews.setBoolean(C0196R.C0198id.chronometer, "setStarted", true);
                            boolean z7 = this.mBuilder.mChronometerCountDown;
                            if (z7 && Build.VERSION.SDK_INT >= 24) {
                                remoteViews.setChronometerCountDown(C0196R.C0198id.chronometer, z7);
                            }
                        } else {
                            remoteViews.setViewVisibility(C0196R.C0198id.time, 0);
                            remoteViews.setLong(C0196R.C0198id.time, "setTime", this.mBuilder.getWhenIfShowing());
                        }
                        remoteViews.setViewVisibility(C0196R.C0198id.right_side, z6 ? 0 : 8);
                        int i3 = C0196R.C0198id.line3;
                        if (!z3) {
                            i2 = 8;
                        }
                ...
                remoteViews.setViewVisibility(C0196R.C0198id.right_side, z6 ? 0 : 8);
                int i32 = C0196R.C0198id.line3;
                if (!z3) {
                }
                remoteViews.setViewVisibility(i32, i2);
                return remoteViews;
            } else {
                if (this.mBuilder.mNumber > resources.getInteger(C0196R.integer.status_bar_notification_info_maxnum)) {
                    remoteViews.setTextViewText(C0196R.C0198id.info, resources.getString(C0196R.string.status_bar_notification_info_overflow));
                } else {
                    remoteViews.setTextViewText(C0196R.C0198id.info, NumberFormat.getIntegerInstance().format(this.mBuilder.mNumber));
                }
            }
            remoteViews.setViewVisibility(C0196R.C0198id.info, 0);
            z3 = true;
            z4 = true;
            charSequence = this.mBuilder.mSubText;
            if (charSequence != null) {
            ...
            remoteViews.setViewVisibility(C0196R.C0198id.right_side, z6 ? 0 : 8);
            int i322 = C0196R.C0198id.line3;
            if (!z3) {
            }
            remoteViews.setViewVisibility(i322, i2);
            return remoteViews;
        }
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            remoteViews.removeAllViews(C0196R.C0198id.notification_main_column);
            remoteViews.addView(C0196R.C0198id.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C0196R.C0198id.notification_main_column, 0);
            remoteViews.setViewPadding(C0196R.C0198id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
        }
    ...
    public static final class WearableExtender implements Extender {
        ...
        @NonNull
        /* renamed from: clone */
        public WearableExtender m4308clone() {
            WearableExtender wearableExtender = new WearableExtender();
