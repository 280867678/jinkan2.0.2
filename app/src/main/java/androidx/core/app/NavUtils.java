...
public final class NavUtils {
    ...
    public static void navigateUpFromSameTask(@NonNull Activity activity) {
        ...
        Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(activity.getClass().getSimpleName());
        Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(" does not have a parent activity name specified. (Did you forget to add the android.support.PARENT_ACTIVITY <meta-data>  element in your manifest?)");
