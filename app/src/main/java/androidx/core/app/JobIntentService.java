    ...
    public static abstract class WorkEnqueuer {
        ...
        public void ensureJobId(int i) {
            if (!this.mHasJobId) {
                ...
                StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Given job ID ", i, " is different than previous ");
                Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(this.mJobId);
