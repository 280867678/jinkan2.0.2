...
public abstract class GnssStatusCompat {
    ...
    @FloatRange(from = RoundRectDrawableWithShadow.COS_45, m4213to = 360.0d)
    public abstract float getAzimuthDegrees(@IntRange(from = 0) int i);

    @FloatRange(from = RoundRectDrawableWithShadow.COS_45, m4213to = 63.0d)
