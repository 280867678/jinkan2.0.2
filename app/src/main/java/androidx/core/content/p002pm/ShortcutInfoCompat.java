...
public class ShortcutInfoCompat {
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Context context, @NonNull ShortcutInfo shortcutInfo) {
            ...
            shortcutInfoCompat2.mId = shortcutInfo.getId();
    ...
    private PersistableBundle buildLegacyExtrasBundle() {
        ...
        if (personArr != null && personArr.length > 0) {
            ...
            while (i < this.mPersons.length) {
                ...
                StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(EXTRA_PERSON_);
                int i2 = i + 1;
                Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(i2);
                persistableBundle.putPersistableBundle(Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.toString(), this.mPersons[i].toPersistableBundle());
                i = i2;
            }
        }
    ...
    public static Person[] getPersonsFromExtra(@NonNull PersistableBundle persistableBundle) {
        ...
        while (i2 < i) {
            StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(EXTRA_PERSON_);
            int i3 = i2 + 1;
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(i3);
            personArr[i2] = Person.fromPersistableBundle(persistableBundle.getPersistableBundle(Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.toString()));
            i2 = i3;
        }
        return personArr;
    }
