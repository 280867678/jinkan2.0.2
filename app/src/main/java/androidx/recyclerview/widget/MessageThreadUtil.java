...
public class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    /* loaded from: classes3.dex */
    public class C05001 implements ThreadUtil.MainThreadCallback<T> {
        ...
        public Runnable mMainThreadRunnable = new Runnable() { // from class: androidx.recyclerview.widget.MessageThreadUtil.1.1
            ...
            public void run() {
                while (true) {
                    SyncQueueItem next = C05001.this.mQueue.next();
                    if (next != null) {
                        int i = next.what;
                        if (i == 1) {
                            C05001.this.val$callback.updateItemCount(next.arg1, next.arg2);
                        } else if (i == 2) {
                            C05001.this.val$callback.addTile(next.arg1, (TileList.Tile) next.data);
                        } else if (i == 3) {
                            C05001.this.val$callback.removeTile(next.arg1, next.arg2);
                        }
                    } else {
                        return;
                    }
        ...
        public C05001(ThreadUtil.MainThreadCallback mainThreadCallback) {
    ...
    /* loaded from: classes3.dex */
    public class C05022 implements ThreadUtil.BackgroundCallback<T> {
        ...
        public Runnable mBackgroundRunnable = new Runnable() { // from class: androidx.recyclerview.widget.MessageThreadUtil.2.1
            ...
            public void run() {
                while (true) {
                    SyncQueueItem next = C05022.this.mQueue.next();
                    if (next == null) {
                        C05022.this.mBackgroundRunning.set(false);
                        return;
                    }
                    int i = next.what;
                    if (i == 1) {
                        C05022.this.mQueue.removeMessages(1);
                        C05022.this.val$callback.refresh(next.arg1);
                    } else if (i == 2) {
                        C05022.this.mQueue.removeMessages(2);
                        C05022.this.mQueue.removeMessages(3);
                        C05022.this.val$callback.updateRange(next.arg1, next.arg2, next.arg3, next.arg4, next.arg5);
                    } else if (i == 3) {
                        C05022.this.val$callback.loadTile(next.arg1, next.arg2);
                    } else if (i == 4) {
                        C05022.this.val$callback.recycleTile((TileList.Tile) next.data);
                    }
                }
            }
        };

        public C05022(ThreadUtil.BackgroundCallback backgroundCallback) {
    ...
    public ThreadUtil.BackgroundCallback<T> getBackgroundProxy(ThreadUtil.BackgroundCallback<T> backgroundCallback) {
        return new C05022(backgroundCallback);
    }

    @Override // androidx.recyclerview.widget.ThreadUtil
    public ThreadUtil.MainThreadCallback<T> getMainThreadProxy(ThreadUtil.MainThreadCallback<T> mainThreadCallback) {
        return new C05001(mainThreadCallback);
    }
}
