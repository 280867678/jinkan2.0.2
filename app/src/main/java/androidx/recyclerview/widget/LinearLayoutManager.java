...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public static class AnchorInfo {
        ...
        public void assignFromViewAndKeepVisibleRect(View view, int i) {
            ...
            if (this.mLayoutFromEnd) {
                ...
                int min2 = decoratedMeasurement - (Math.min(this.mOrientationHelper.getDecoratedStart(view) - startAfterPadding, 0) + startAfterPadding);
                if (min2 >= 0) {
                    return;
                }
                min = Math.min(endAfterPadding, -min2) + this.mCoordinate;
            } else {
                ...
                min = this.mCoordinate - Math.min(startAfterPadding2, -endAfterPadding2);
            }
        ...
        public String toString() {
            StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("AnchorInfo{mPosition=");
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(this.mPosition);
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(", mCoordinate=");
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(this.mCoordinate);
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(", mLayoutFromEnd=");
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(this.mLayoutFromEnd);
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(", mValid=");
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(this.mValid);
    ...
    public static class SavedState implements Parcelable {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() { // from class: androidx.recyclerview.widget.LinearLayoutManager.SavedState.1
            ...
            public SavedState mo4348createFromParcel(Parcel parcel) {
            ...
            public SavedState[] mo4349newArray(int i) {
    ...
    private void updateLayoutState(int i, int i2, boolean z, RecyclerView.State state) {
        ...
        if (z2) {
            ...
            layoutState7.mItemDirection = i3;
        ...
        if (z) {
            layoutState10.mAvailable = i2 - startAfterPadding;
        }
    ...
    public void setOrientation(int i) {
        ...
        throw new IllegalArgumentException(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("invalid orientation:", i));
    }
    ...
    public void validateChildOrder() {
        ...
        if (this.mShouldReverseLayout) {
            for (int i = 1; i < getChildCount(); i++) {
                ...
                if (position2 < position) {
                    logChildren();
                    StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("detected invalid position. loc invalid? ");
                    if (decoratedStart2 >= decoratedStart) {
                        z = false;
                    }
                    Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(z);
        ...
        for (int i2 = 1; i2 < getChildCount(); i2++) {
            ...
            if (position3 < position) {
                logChildren();
                StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2 = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("detected invalid position. loc invalid? ");
                if (decoratedStart3 >= decoratedStart) {
                    z = false;
                }
                Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2.append(z);
