...
public class ViewBoundsCheck {
    ...
    /* renamed from: EQ */
    public static final int f70EQ = 2;
    ...
    /* renamed from: GT */
    public static final int f71GT = 1;

    /* renamed from: LT */
    public static final int f72LT = 4;
    ...
    public static class BoundFlags {
        ...
        public boolean boundsMatch() {
            ...
            if ((i & 7) == 0 || (i & (compare(this.mChildStart, this.mRvStart) << 0)) != 0) {
                ...
                return (i4 & UMModuleRegister.SHARE_EVENT_VALUE_HIGH) == 0 || (i4 & (compare(this.mChildEnd, this.mRvEnd) << 12)) != 0;
            }
            return false;
        }
