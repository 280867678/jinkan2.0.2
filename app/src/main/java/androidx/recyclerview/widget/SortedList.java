...
public class SortedList<T> {
    ...
    private void addToData(int i, T t) {
        int i2 = this.mSize;
        if (i > i2) {
            StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("cannot add item to ", i, " because size is ");
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(this.mSize);
    ...
    public T get(int i) throws IndexOutOfBoundsException {
        ...
        StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Asked to get item at ", i, " but size is ");
        Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(this.mSize);
        throw new IndexOutOfBoundsException(Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.toString());
    }
