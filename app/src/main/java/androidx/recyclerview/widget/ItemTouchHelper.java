...
import androidx.recyclerview.C0470R;
...
public class ItemTouchHelper extends RecyclerView.ItemDecoration implements RecyclerView.OnChildAttachStateChangeListener {
        ...
        public boolean onInterceptTouchEvent(@NonNull RecyclerView recyclerView, @NonNull MotionEvent motionEvent) {
            ...
            if (actionMasked == 0) {
                ...
                if (itemTouchHelper.mSelected == null && (findAnimation = itemTouchHelper.findAnimation(motionEvent)) != null) {
                    ItemTouchHelper itemTouchHelper2 = ItemTouchHelper.this;
                    itemTouchHelper2.mInitialTouchX -= findAnimation.f68mX;
                    itemTouchHelper2.mInitialTouchY -= findAnimation.f69mY;
    ...
    /* loaded from: classes3.dex */
    public class C04945 implements RecyclerView.ChildDrawingOrderCallback {
        public C04945() {
        }
    ...
    public static abstract class Callback {
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (this.mCachedMaxScrollSpeed == -1) {
                this.mCachedMaxScrollSpeed = recyclerView.getResources().getDimensionPixelSize(C0470R.dimen.item_touch_helper_max_drag_scroll_per_frame);
            }
        ...
        public int interpolateOutOfBoundsScroll(@NonNull RecyclerView recyclerView, int i, int i2, int i3, long j) {
            float f = 1.0f;
            int interpolation = (int) (sDragViewScrollCapInterpolator.getInterpolation(Math.min(1.0f, (Math.abs(i2) * 1.0f) / i)) * ((int) Math.signum(i2)) * getMaxDragScroll(recyclerView));
            if (j <= 2000) {
                f = ((float) j) / 2000.0f;
            }
        ...
        public void onDraw(Canvas canvas, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, List<RecoverAnimation> list, int i, float f, float f2) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                onChildDraw(canvas, recyclerView, recoverAnimation.mViewHolder, recoverAnimation.f68mX, recoverAnimation.f69mY, recoverAnimation.mActionState, false);
        ...
        public void onDrawOver(Canvas canvas, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, List<RecoverAnimation> list, int i, float f, float f2) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                RecoverAnimation recoverAnimation = list.get(i2);
                int save = canvas.save();
                onChildDrawOver(canvas, recyclerView, recoverAnimation.mViewHolder, recoverAnimation.f68mX, recoverAnimation.f69mY, recoverAnimation.mActionState, false);
                canvas.restoreToCount(save);
            }
            if (viewHolder != null) {
                int save2 = canvas.save();
    ...
    public static class RecoverAnimation implements Animator.AnimatorListener {
        ...
        public void update() {
            ...
            this.f68mX = f == f2 ? this.mViewHolder.itemView.getTranslationX() : outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(f2, f, this.mFraction, f);
            float f3 = this.mStartDy;
            float f4 = this.mTargetY;
            this.f69mY = f3 == f4 ? this.mViewHolder.itemView.getTranslationY() : outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(f4, f3, this.mFraction, f3);
        }
    }
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView) {
        ...
        this.mSwipeEscapeVelocity = resources.getDimension(C0470R.dimen.item_touch_helper_swipe_escape_velocity);
        this.mMaxSwipeVelocity = resources.getDimension(C0470R.dimen.item_touch_helper_swipe_escape_max_velocity);
        setupCallbacks();
    }
    ...
    public View findChildView(MotionEvent motionEvent) {
        ...
        for (int size = this.mRecoverAnimations.size() - 1; size >= 0; size--) {
            ...
            if (hitTest(view2, x, y, recoverAnimation.f68mX, recoverAnimation.f69mY)) {
                return view2;
            }
        }
    ...
    */
    public boolean scrollIfNecessary() {
        ...
        if (layoutManager.canScrollHorizontally()) {
            ...
            if ((this.mDx < 0.0f && paddingLeft < 0) || (this.mDx > 0.0f && (paddingLeft = ((this.mSelected.itemView.getWidth() + i4) + this.mTmpRect.right) - (this.mRecyclerView.getWidth() - this.mRecyclerView.getPaddingRight())) > 0)) {
                i = paddingLeft;
                if (layoutManager.canScrollVertically()) {
                    int i5 = (int) (this.mSelectedStartY + this.mDy);
                    int paddingTop = (i5 - this.mTmpRect.top) - this.mRecyclerView.getPaddingTop();
                    if ((this.mDy < 0.0f && paddingTop < 0) || (this.mDy > 0.0f && (paddingTop = ((this.mSelected.itemView.getHeight() + i5) + this.mTmpRect.bottom) - (this.mRecyclerView.getHeight() - this.mRecyclerView.getPaddingBottom())) > 0)) {
                        i2 = paddingTop;
                        if (i != 0) {
