...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public static class ChangeInfo {
        ...
        public String toString() {
            StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("ChangeInfo{oldHolder=");
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(this.oldHolder);
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(", newHolder=");
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(this.newHolder);
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(", fromX=");
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(this.fromX);
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(", fromY=");
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(this.fromY);
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(", toX=");
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(this.toX);
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(", toY=");
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(this.toY);
    ...
    public void runPendingAnimations() {
        ...
        if (z || z2 || z4 || z3) {
            ...
            ViewCompat.postOnAnimationDelayed(arrayList3.get(0).itemView, runnable3, Math.max(moveDuration, j) + removeDuration);
        }
    }
}
