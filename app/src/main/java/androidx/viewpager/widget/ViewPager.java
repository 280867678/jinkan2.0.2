...
public class ViewPager extends ViewGroup {
    ...
    public interface OnPageChangeListener {
        ...
        void onPageScrolled(int i, float f, @AbstractC0047Px int i2);
    ...
    public static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: androidx.viewpager.widget.ViewPager.SavedState.1
            ...
            public SavedState mo4392createFromParcel(Parcel parcel) {
            ...
            /* renamed from: createFromParcel */
            public SavedState mo4393createFromParcel(Parcel parcel, ClassLoader classLoader) {
                return new SavedState(parcel, classLoader);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public SavedState[] mo4394newArray(int i) {
        ...
        public String toString() {
            StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("FragmentPager.SavedState{");
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(Integer.toHexString(System.identityHashCode(this)));
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(" position=");
            return outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww, this.position, "}");
        }
    ...
    private void recomputeScrollPosition(int i, int i2, int i3, int i4) {
        ...
        if (i2 <= 0 || this.mItems.isEmpty()) {
            ...
            min = (int) ((infoForPosition != null ? Math.min(infoForPosition.offset, this.mLastOffset) : 0.0f) * ((i - getPaddingLeft()) - getPaddingRight()));
            if (min == getScrollX()) {
                return;
            }
                    ...
                    if (!this.mIsBeingDragged) {
                        ...
                        if (findPointerIndex != -1) {
                            ...
                            if (abs > this.mTouchSlop && abs > abs2) {
                                ...
                                this.mLastMotionX = x - f > 0.0f ? f + this.mTouchSlop : f - this.mTouchSlop;
                                this.mLastMotionY = y;
                                setScrollState(1);
                                setScrollingCacheEnabled(true);
                                ViewParent parent = getParent();
    ...
    public void populate(int i) {
        ...
        if (this.mAdapter == null) {
            ...
            if (count != this.mExpectedAdapterCount) {
                ...
                StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("The application's PagerAdapter changed the adapter's contents without calling PagerAdapter#notifyDataSetChanged! Expected adapter item count: ");
                Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(this.mExpectedAdapterCount);
                Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(", found: ");
                Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(count);
                Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(" Pager id: ");
                Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(hexString);
                Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(" Pager class: ");
                Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(getClass());
                Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(" Problematic adapter: ");
                Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(this.mAdapter.getClass());
            ...
            if (itemInfo2 != null) {
                ...
                for (int i8 = this.mCurItem - 1; i8 >= 0; i8--) {
                    if (f < paddingLeft || i8 >= max) {
                        if (itemInfo3 == null || i8 != itemInfo3.position) {
                    ...
                    while (true) {
                        ...
                        if (i10 >= count) {
                            ...
                            if (itemInfo4 == null || i10 != itemInfo4.position) {
                                ...
                                itemInfo4 = i9 < this.mItems.size() ? this.mItems.get(i9) : null;
                            } else {
