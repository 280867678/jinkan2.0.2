...
import androidx.viewpager2.C0616R;
...
public final class ViewPager2 extends ViewGroup {
    ...
    public static abstract class OnPageChangeCallback {
        ...
        public void onPageScrolled(int i, float f, @AbstractC0047Px int i2) {
        }
    ...
    public static class SavedState extends View.BaseSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: androidx.viewpager2.widget.ViewPager2.SavedState.1
            ...
            public SavedState mo4395createFromParcel(Parcel parcel) {
                return mo4396createFromParcel(parcel, (ClassLoader) null);
            }

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.os.Parcelable.ClassLoaderCreator
            /* renamed from: createFromParcel */
            public SavedState mo4396createFromParcel(Parcel parcel, ClassLoader classLoader) {
                return Build.VERSION.SDK_INT >= 24 ? new SavedState(parcel, classLoader) : new SavedState(parcel);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public SavedState[] mo4397newArray(int i) {
    ...
    private void setOrientation(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0616R.styleable.ViewPager2);
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C0616R.styleable.ViewPager2, attributeSet, obtainStyledAttributes, 0, 0);
        }
        try {
            setOrientation(obtainStyledAttributes.getInt(C0616R.styleable.ViewPager2_android_orientation, 0));
        } finally {
    ...
    public boolean fakeDragBy(@AbstractC0047Px @SuppressLint({"SupportAnnotationUsage"}) float f) {
