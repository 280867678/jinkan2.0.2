...
public abstract class FragmentStateAdapter extends RecyclerView.Adapter<FragmentViewHolder> implements StatefulAdapter {
    ...
    public static String createKey(@NonNull String str, long j) {
        return outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(str, j);
    }
    ...
    public void placeFragmentInViewHolder(@NonNull final FragmentViewHolder fragmentViewHolder) {
        ...
        if (fragment != null) {
            ...
            if (fragment.isAdded() && view == null) {
                ...
                StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("f");
                Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(fragmentViewHolder.getItemId());
                beginTransaction.add(fragment, Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.toString()).setMaxLifecycle(fragment, Lifecycle.State.STARTED).commitNow();
    ...
    public final void restoreState(@NonNull Parcelable parcelable) {
        ...
        for (String str : bundle.keySet()) {
            if (isValidKey(str, KEY_PREFIX_FRAGMENT)) {
                ...
                throw new IllegalArgumentException(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Unexpected key in savedState: ", str));
            } else {
