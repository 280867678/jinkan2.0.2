        ...
        try {
            try {
                ...
                try {
                    ...
                    throw new RuntimeException(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Failed to instantiate ", str), e);
                }
                ...
                Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(" must have default constructor in order to be automatically recreated");
                throw new IllegalStateException(Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.toString(), e2);
            }
        } catch (ClassNotFoundException e3) {
            throw new RuntimeException(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Class ", str, " wasn't found"), e3);
        }
    }
