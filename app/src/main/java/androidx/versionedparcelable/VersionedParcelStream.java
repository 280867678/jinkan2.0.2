    ...
    private void readObject(int i, String str, Bundle bundle) {
        switch (i) {
            ...
            case 14:
                ...
                return;
            default:
                throw new RuntimeException(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Unknown type ", i));
        }
    }
    ...
    private void writeObject(Object obj) {
        ...
        if (obj == null) {
            ...
            if (obj instanceof int[]) {
                ...
                StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Unsupported type ");
