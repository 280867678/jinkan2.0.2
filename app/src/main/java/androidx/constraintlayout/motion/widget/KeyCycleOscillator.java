...
public abstract class KeyCycleOscillator {
    ...
    public static class CycleOscillator {
        ...
        public void setup(float f) {
            ...
            if (this.mPosition[0] > RoundRectDrawableWithShadow.COS_45) {
                this.mOscillator.addPoint(RoundRectDrawableWithShadow.COS_45, this.mPeriod[0]);
            }
    ...
    public String toString() {
        ...
        while (it.hasNext()) {
            ...
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(next.mPosition);
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(" , ");
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(decimalFormat.format(next.mValue));
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append("] ");
