...
public class MotionScene {
    ...
    public static class Transition {
        ...
        public static class TransitionOnClick implements View.OnClickListener {
            ...
            public TransitionOnClick(Context context, Transition transition, XmlPullParser xmlPullParser) {
                ...
                TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), C0186R.styleable.OnClick);
                int indexCount = obtainStyledAttributes.getIndexCount();
                for (int i = 0; i < indexCount; i++) {
                    int index = obtainStyledAttributes.getIndex(i);
                    if (index == C0186R.styleable.OnClick_targetId) {
                        this.mTargetId = obtainStyledAttributes.getResourceId(index, this.mTargetId);
                    } else if (index == C0186R.styleable.OnClick_clickAction) {
            ...
            public void addOnClickListeners(MotionLayout motionLayout, int i, Transition transition) {
                ...
                boolean z = true;
                boolean z2 = ((this.mMode & 1) != 0 && i == i3) | ((this.mMode & 1) != 0 && i == i3) | ((this.mMode & 256) != 0 && i == i3) | ((this.mMode & 16) != 0 && i == i4);
                if ((this.mMode & 4096) == 0 || i != i4) {
                    z = false;
                }
                if (!z2 && !z) {
                    return;
        ...
        private void fill(MotionScene motionScene, Context context, TypedArray typedArray) {
            ...
            for (int i2 = 0; i2 < indexCount; i2++) {
                ...
                if (index == C0186R.styleable.Transition_constraintSetEnd) {
                    ...
                    if (index == C0186R.styleable.Transition_constraintSetStart) {
                    ...
                    } else if (index == C0186R.styleable.Transition_motionInterpolator) {
                    ...
                    } else if (index == C0186R.styleable.Transition_duration) {
                        this.mDuration = typedArray.getInt(index, this.mDuration);
                    } else if (index == C0186R.styleable.Transition_staggered) {
                        this.mStagger = typedArray.getFloat(index, this.mStagger);
                    } else if (index == C0186R.styleable.Transition_autoTransition) {
                        this.mAutoTransition = typedArray.getInteger(index, this.mAutoTransition);
                    } else if (index == C0186R.styleable.Transition_android_id) {
                        this.mId = typedArray.getResourceId(index, this.mId);
                    } else if (index == C0186R.styleable.Transition_transitionDisable) {
                        this.mDisable = typedArray.getBoolean(index, this.mDisable);
                    } else if (index == C0186R.styleable.Transition_pathMotionArc) {
                        this.mPathMotionArc = typedArray.getInteger(index, -1);
                    } else if (index == C0186R.styleable.Transition_layoutDuringTransition) {
                        this.mLayoutDuringTransition = typedArray.getInteger(index, 0);
                    } else if (index == C0186R.styleable.Transition_transitionFlags) {
        ...
        private void fillFromAttributeList(MotionScene motionScene, Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0186R.styleable.Transition);
        ...
        public String debugString(Context context) {
            ...
            if (this.mConstraintSetEnd == -1) {
                return outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(resourceEntryName, " -> null");
            }
            StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(resourceEntryName, " -> ");
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(context.getResources().getResourceEntryName(this.mConstraintSetEnd));
    ...
    public MotionScene(Context context, MotionLayout motionLayout, int i) {
        ...
        load(context, i);
        this.mConstraintSetMap.put(C0186R.C0189id.motion_base, new ConstraintSet());
        this.mConstraintSetIdMap.put("motion_base", Integer.valueOf(C0186R.C0189id.motion_base));
    }
    ...
    private void parseMotionSceneTags(Context context, XmlPullParser xmlPullParser) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), C0186R.styleable.MotionScene);
        int indexCount = obtainStyledAttributes.getIndexCount();
        for (int i = 0; i < indexCount; i++) {
            int index = obtainStyledAttributes.getIndex(i);
            if (index == C0186R.styleable.MotionScene_defaultDuration) {
                this.mDefaultDuration = obtainStyledAttributes.getInt(index, this.mDefaultDuration);
            } else if (index == C0186R.styleable.MotionScene_layoutDuringTransition) {
    ...
    public boolean autoTransition(MotionLayout motionLayout, int i) {
        ...
        MotionLayout.TransitionState transitionState2;
                ...
                if (next.mAutoTransition != 0) {
                    if (i == next.mConstraintSetStart && (next.mAutoTransition == 4 || next.mAutoTransition == 2)) {
                        ...
                        if (next.mAutoTransition == 4) {
                            ...
                            transitionState2 = MotionLayout.TransitionState.FINISHED;
                        }
                        ...
                        if (next.mAutoTransition == 3) {
                            ...
                            motionLayout.setState(MotionLayout.TransitionState.SETUP);
                            motionLayout.setState(MotionLayout.TransitionState.MOVING);
                            transitionState = MotionLayout.TransitionState.FINISHED;
                        }
    ...
    public ConstraintSet getConstraintSet(int i, int i2, int i3) {
        ...
        if (this.DEBUG_DESKTOP) {
            ...
            StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("size ");
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(this.mConstraintSetMap.size());
            printStream2.println(Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.toString());
        }
        StateSet stateSet = this.mStateSet;
    ...
    public void processTouchEvent(MotionEvent motionEvent, int i, MotionLayout motionLayout) {
        ...
        if (i != -1) {
            ...
            if (action == 0) {
                ...
                if ((rawX == RoundRectDrawableWithShadow.COS_45 && rawY == RoundRectDrawableWithShadow.COS_45) || (motionEvent2 = this.mLastTouchDown) == null) {
                    return;
                }
