...
public class ArrayLinkedVariables implements ArrayRow.ArrayRowVariables {
    ...
    public void add(SolverVariable solverVariable, float f, boolean z) {
        ...
        if (f <= (-f2) || f >= f2) {
            ...
            if (i == -1) {
                ...
                this.mArrayIndices[0] = solverVariable.f31id;
            ...
            this.mArrayIndices[i7] = solverVariable.f31id;
    ...
    public String toString() {
        ...
        String str = "";
        for (int i2 = 0; i != -1 && i2 < this.currentSize; i2++) {
            StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(str, " -> "));
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(this.mArrayValues[i]);
            ...
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2.append(this.mCache.mIndexedVariables[this.mArrayIndices[i]]);
