...
public class State {
    ...
    public static /* synthetic */ class C01701 {
        ...
        static {
            ...
            try {
                int[] iArr2 = $SwitchMap$androidx$constraintlayout$solver$state$State$Helper;
                Helper helper2 = Helper.VERTICAL_CHAIN;
                iArr2[1] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                int[] iArr3 = $SwitchMap$androidx$constraintlayout$solver$state$State$Helper;
                Helper helper3 = Helper.ALIGN_HORIZONTALLY;
                iArr3[2] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                int[] iArr4 = $SwitchMap$androidx$constraintlayout$solver$state$State$Helper;
                Helper helper4 = Helper.ALIGN_VERTICALLY;
                iArr4[3] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                int[] iArr5 = $SwitchMap$androidx$constraintlayout$solver$state$State$Helper;
    ...
    private String createHelperKey() {
        StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("__HELPER_KEY_");
        int i = this.numHelpers;
        this.numHelpers = i + 1;
        return outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww, i, "__");
    }
