        ...
        while (z4) {
            ...
            if (!z3 || i3 >= 8 || !Optimizer.flags[2]) {
                ...
                for (int i8 = 0; i8 < size; i8++) {
                    ...
                    i6 = Math.max(i6, constraintWidget2.getWidth() + constraintWidget2.f35mX);
                    i7 = Math.max(i7, constraintWidget2.getHeight() + constraintWidget2.f36mY);
                }
            ...
            if (!z5) {
                ...
                if (dimensionBehaviourArr2[c] == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT && max2 > 0 && getHeight() > max2) {
