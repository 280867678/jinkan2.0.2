...
public class ConstraintProperties {
    ...
    public ConstraintProperties centerHorizontally(int i) {
        ...
        constraintProperties.center(i6, i2, i3, i7, i4, i5, f);
        return this;
    }
        ...
        switch (i) {
            case 1:
                if (i3 == 1) {
                    ...
                    throw new IllegalArgumentException(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Left to "), sideToString(i3), " undefined"));
                } else {
            ...
            case 2:
                if (i3 == 1) {
                    ...
                    layoutParams5.rightToLeft = i2;
                    layoutParams5.rightToRight = -1;
                } else if (i3 != 2) {
                    throw new IllegalArgumentException(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("right to "), sideToString(i3), " undefined"));
                } else {
            ...
            case 5:
                ...
                layoutParams7.baselineToBaseline = i2;
            ...
            default:
                ...
                sb.append(" to ");
                throw new IllegalArgumentException(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(sb, sideToString(i3), " unknown"));
        }
        return this;
    }
