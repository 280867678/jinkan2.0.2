    ...
    */
                ...
                if (next == 2) {
                    ...
                    if (name.equals("objectAnimator")) {
                        ...
                        if (name.equals("set")) {
                            ...
                            StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Unknown animator name: ");
    ...
    public static void dumpKeyframes(Object[] objArr, String str) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Keyframe ", i, ": fraction ");
            Object obj = "null";
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(keyframe.getFraction() < 0.0f ? obj : Float.valueOf(keyframe.getFraction()));
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(", , value : ");
            if (keyframe.hasValue()) {
                obj = keyframe.getValue();
            }
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(obj);
