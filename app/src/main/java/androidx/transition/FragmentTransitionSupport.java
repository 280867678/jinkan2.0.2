...
public class FragmentTransitionSupport extends FragmentTransitionImpl {
    ...
    public void addTarget(Object obj, View view) {
        if (obj != null) {
            ((Transition) obj).mo4377addTarget(view);
        }
    }
    ...
    public void addTargets(Object obj, ArrayList<View> arrayList) {
        ...
        if (transition instanceof TransitionSet) {
            ...
            while (i < size) {
                transition.mo4377addTarget(arrayList.get(i));
                i++;
            }
        }
    }
    ...
    public Object cloneTransition(Object obj) {
        if (obj != null) {
            return ((Transition) obj).m4374clone();
        }
        return null;
    }
    ...
    public void removeTarget(Object obj, View view) {
        if (obj != null) {
            ((Transition) obj).mo4383removeTarget(view);
        }
    }
    ...
    public void replaceTargets(Object obj, ArrayList<View> arrayList, ArrayList<View> arrayList2) {
        ...
        if (transition instanceof TransitionSet) {
            ...
            while (i < size) {
                transition.mo4377addTarget(arrayList2.get(i));
                i++;
            }
            for (int size2 = arrayList.size() - 1; size2 >= 0; size2--) {
                transition.mo4383removeTarget(arrayList.get(size2));
            }
        }
    }
    ...
    public void scheduleHideFragmentView(Object obj, final View view, final ArrayList<View> arrayList) {
        ((Transition) obj).mo4375addListener(new Transition.TransitionListener() { // from class: androidx.transition.FragmentTransitionSupport.2
    ...
    public void scheduleRemoveTargets(Object obj, final Object obj2, final ArrayList<View> arrayList, final Object obj3, final ArrayList<View> arrayList2, final Object obj4, final ArrayList<View> arrayList3) {
        ((Transition) obj).mo4375addListener(new TransitionListenerAdapter() { // from class: androidx.transition.FragmentTransitionSupport.3
