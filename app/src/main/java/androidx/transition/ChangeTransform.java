...
public class ChangeTransform extends Transition {
    ...
    public static class GhostListener extends TransitionListenerAdapter {
        ...
        public void onTransitionEnd(@NonNull Transition transition) {
            ...
            this.mView.setTag(C0574R.C0576id.transition_transform, null);
            this.mView.setTag(C0574R.C0576id.parent_matrix, null);
        }
    ...
    private void captureValues(TransitionValues transitionValues) {
        ...
        transitionValues.values.put(PROPNAME_INTERMEDIATE_MATRIX, view.getTag(C0574R.C0576id.transition_transform));
        transitionValues.values.put(PROPNAME_INTERMEDIATE_PARENT_MATRIX, view.getTag(C0574R.C0576id.parent_matrix));
    }
    ...
    private void createGhostView(ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        transition.mo4375addListener(new GhostListener(view, addGhost));
    ...
    private ObjectAnimator createTransformAnimator(TransitionValues transitionValues, TransitionValues transitionValues2, final boolean z) {
        ...
        AnimatorListenerAdapter animatorListenerAdapter = new AnimatorListenerAdapter() { // from class: androidx.transition.ChangeTransform.3
            ...
            private void setCurrentMatrix(Matrix matrix4) {
                ...
                view.setTag(C0574R.C0576id.transition_transform, this.mTempMatrix);
            ...
            public void onAnimationEnd(Animator animator) {
                if (!this.mIsCanceled) {
                    if (!z || !ChangeTransform.this.mUseOverlay) {
                        view.setTag(C0574R.C0576id.transition_transform, null);
                        view.setTag(C0574R.C0576id.parent_matrix, null);
                    } else {
    ...
    */
    ...
    private void setMatricesForParent(TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        transitionValues2.view.setTag(C0574R.C0576id.parent_matrix, matrix);
