        ...
        if (z) {
            ...
            if (layoutTransition3 != null) {
                ...
                if (layoutTransition3 != sEmptyLayoutTransition) {
                    viewGroup.setTag(C0574R.C0576id.transition_layout_save, layoutTransition3);
                }
            }
            ...
            layoutTransition = (LayoutTransition) viewGroup.getTag(C0574R.C0576id.transition_layout_save);
            if (layoutTransition == null) {
                return;
            }
            viewGroup.setTag(C0574R.C0576id.transition_layout_save, null);
        }
