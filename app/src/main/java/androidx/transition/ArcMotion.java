...
public class ArcMotion extends PathMotion {
    ...
    public float mMinimumHorizontalAngle = 0.0f;
    public float mMinimumVerticalAngle = 0.0f;
    public float mMaximumAngle = 70.0f;
    ...
    public Path getPath(float f, float f2, float f3, float f4) {
        ...
        if (f15 != 0.0f) {
            ...
            f5 = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(f5, f11, sqrt, f11);
            f6 = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(f6, f12, sqrt, f12);
        }
