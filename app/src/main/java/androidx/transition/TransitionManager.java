...
public class TransitionManager {
    ...
    public static class MultiListener implements ViewTreeObserver.OnPreDrawListener, View.OnAttachStateChangeListener {
        ...
        public boolean onPreDraw() {
            ...
            this.mTransition.mo4375addListener(new TransitionListenerAdapter() { // from class: androidx.transition.TransitionManager.MultiListener.1
    ...
    public static void beginDelayedTransition(@NonNull ViewGroup viewGroup, @Nullable Transition transition) {
        ...
        Transition m4374clone = transition.m4374clone();
        sceneChangeSetup(viewGroup, m4374clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, m4374clone);
    }
    ...
    public static void changeScene(Scene scene, Transition transition) {
        ...
        if (!sPendingTransitions.contains(sceneRoot)) {
            ...
            Transition m4374clone = transition.m4374clone();
            m4374clone.mo4388setSceneRoot(sceneRoot);
            if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
                m4374clone.setCanRemoveViews(true);
            }
            sceneChangeSetup(sceneRoot, m4374clone);
            scene.enter();
            sceneChangeRunTransition(sceneRoot, m4374clone);
        }
    }
    ...
    /* renamed from: go */
    public static void m4195go(@NonNull Scene scene) {
        changeScene(scene, sDefaultTransition);
    }

    /* renamed from: go */
    public static void m4194go(@NonNull Scene scene, @Nullable Transition transition) {
