...
public class GhostViewPort extends ViewGroup implements GhostView {
    ...
    public final ViewTreeObserver.OnPreDrawListener mOnPreDrawListener = new ViewTreeObserver.OnPreDrawListener() { // from class: androidx.transition.GhostViewPort.1
    ...
    public static GhostViewPort getGhostView(View view) {
        return (GhostViewPort) view.getTag(C0574R.C0576id.ghost_view);
    }
    ...
    public static void setGhostView(@NonNull View view, @Nullable GhostViewPort ghostViewPort) {
        view.setTag(C0574R.C0576id.ghost_view, ghostViewPort);
    }
