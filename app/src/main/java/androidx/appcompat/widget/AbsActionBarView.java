...
public abstract class AbsActionBarView extends ViewGroup {
    ...
    public AbsActionBarView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (!context.getTheme().resolveAttribute(C0049R.attr.actionBarPopupTheme, typedValue, true) || typedValue.resourceId == 0) {
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(null, C0049R.styleable.ActionBar, C0049R.attr.actionBarStyle, 0);
        setContentHeight(obtainStyledAttributes.getLayoutDimension(C0049R.styleable.ActionBar_height, 0));
