...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
    ...
    private void onMeasureExactFormat(int i, int i2) {
        ...
        if (i10 <= 0 || j == 0 || (i10 >= i15 - 1 && !z9 && i16 <= 1)) {
            ...
            int i35 = bitCount > 0.0f ? (int) ((i10 * i12) / bitCount) : 0;
            z2 = z;
    ...
    public LayoutParams mo4277generateLayoutParams(ViewGroup.LayoutParams layoutParams) {
        ...
        return mo4275generateDefaultLayoutParams();
    }

    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public LayoutParams generateOverflowButtonLayoutParams() {
        LayoutParams mo4275generateDefaultLayoutParams = mo4275generateDefaultLayoutParams();
        mo4275generateDefaultLayoutParams.isOverflowButton = true;
        return mo4275generateDefaultLayoutParams;
    }
