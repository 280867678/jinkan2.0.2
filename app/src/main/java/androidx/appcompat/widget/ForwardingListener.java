...
public abstract class ForwardingListener implements View.OnTouchListener, View.OnAttachStateChangeListener {
    ...
    private boolean onTouchForwarded(MotionEvent motionEvent) {
        ...
        View view = this.mSrc;
        ShowableListMenu mo4281getPopup = mo4281getPopup();
        if (mo4281getPopup == null || !mo4281getPopup.isShowing() || (dropDownListView = (DropDownListView) mo4281getPopup.getListView()) == null || !dropDownListView.isShown()) {
            return false;
        }
    ...
    */
    ...
    public abstract ShowableListMenu mo4281getPopup();

    public boolean onForwardingStarted() {
        ShowableListMenu mo4281getPopup = mo4281getPopup();
        if (mo4281getPopup == null || mo4281getPopup.isShowing()) {
            return true;
        }
        mo4281getPopup.show();
        return true;
