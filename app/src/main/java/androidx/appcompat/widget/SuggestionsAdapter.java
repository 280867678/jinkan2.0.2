...
public class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    public static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0049R.C0052id.edit_query);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mProviderContext.getTheme().resolveAttribute(C0049R.attr.textColorSearchUrl, typedValue, true);
        ...
        if (!TextUtils.isEmpty(authority)) {
            try {
                ...
                if (pathSegments == null) {
                    throw new FileNotFoundException(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("No path: ", uri));
                }
                ...
                if (size == 1) {
                    try {
                        ...
                        throw new FileNotFoundException(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Single path segment is not a resource ID: ", uri));
                    }
                } else if (size != 2) {
                    throw new FileNotFoundException(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("More than two path segments: ", uri));
                } else {
                    parseInt = resourcesForApplication.getIdentifier(pathSegments.get(1), pathSegments.get(0), authority);
                }
                if (parseInt == 0) {
                    throw new FileNotFoundException(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("No resource found for: ", uri));
                }
                return resourcesForApplication.getDrawable(parseInt);
            } catch (PackageManager.NameNotFoundException unused2) {
                throw new FileNotFoundException(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("No package found for authority: ", uri));
            }
        }
        throw new FileNotFoundException(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("No authority: ", uri));
    }
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        ((ImageView) newView.findViewById(C0049R.C0052id.edit_query)).setImageResource(this.mCommitIconResId);
        return newView;
    }
