...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
        ...
        */
        public void computeContentWidth() {
            ...
            if (i3 == -2) {
                ...
                setContentWidth(i3);
                setHorizontalOffset(!ViewUtils.isLayoutRtl(AppCompatSpinner.this) ? (((width - paddingRight) - getWidth()) - getHorizontalOriginalOffset()) + i2 : getHorizontalOriginalOffset() + paddingLeft + i2);
            } else {
    ...
    public static class SavedState extends View.BaseSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() { // from class: androidx.appcompat.widget.AppCompatSpinner.SavedState.1
            ...
            public SavedState mo4279createFromParcel(Parcel parcel) {
            ...
            public SavedState[] mo4280newArray(int i) {
    ...
    public AppCompatSpinner(@NonNull Context context, int i) {
        this(context, null, C0049R.attr.spinnerStyle, i);
    }

    public AppCompatSpinner(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C0049R.attr.spinnerStyle);
    }
    ...
    */
    public AppCompatSpinner(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i2, Resources.Theme theme) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0049R.styleable.Spinner, i, 0);
        this.mBackgroundTintHelper = new AppCompatBackgroundHelper(this);
        if (theme != null) {
            contextThemeWrapper = new ContextThemeWrapper(context, theme);
        } else {
            int resourceId = obtainStyledAttributes.getResourceId(C0049R.styleable.Spinner_popupTheme, 0);
            if (resourceId == 0) {
                ...
                if (i2 != 0) {
                    ...
                    dialogPopup.setPromptText(obtainStyledAttributes.getString(C0049R.styleable.Spinner_android_prompt));
                } else if (i2 == 1) {
                    final DropdownPopup dropdownPopup = new DropdownPopup(this.mPopupContext, attributeSet, i);
                    TintTypedArray obtainStyledAttributes2 = TintTypedArray.obtainStyledAttributes(this.mPopupContext, attributeSet, C0049R.styleable.Spinner, i, 0);
                    this.mDropDownWidth = obtainStyledAttributes2.getLayoutDimension(C0049R.styleable.Spinner_android_dropDownWidth, -2);
                    dropdownPopup.setBackgroundDrawable(obtainStyledAttributes2.getDrawable(C0049R.styleable.Spinner_android_popupBackground));
                    dropdownPopup.setPromptText(obtainStyledAttributes.getString(C0049R.styleable.Spinner_android_prompt));
                ...
                textArray = obtainStyledAttributes.getTextArray(C0049R.styleable.Spinner_android_entries);
                if (textArray != null) {
                    ArrayAdapter arrayAdapter = new ArrayAdapter(context, 17367048, textArray);
                    arrayAdapter.setDropDownViewResource(C0049R.layout.support_simple_spinner_dropdown_item);
