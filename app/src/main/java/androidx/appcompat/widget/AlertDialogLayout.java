    ...
    private boolean tryOnMeasure(int i, int i2) {
        ...
        for (int i7 = 0; i7 < childCount; i7++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C0049R.C0052id.topPanel) {
                    view = childAt;
                } else if (id == C0049R.C0052id.buttonPanel) {
                    view2 = childAt;
                } else if ((id != C0049R.C0052id.contentPanel && id != C0049R.C0052id.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt != null && childAt.getVisibility() != 8) {
                ...
                paddingTop = measuredHeight2 + ((LinearLayout.LayoutParams) layoutParams).bottomMargin + i122;
            }
        }
    }
