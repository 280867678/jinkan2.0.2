...
public class AlertDialog extends AppCompatDialog implements DialogInterface {
    ...
    public static class Builder {
        ...
        /* renamed from: P */
        public final AlertController.AlertParams f5P;
        ...
        public AlertDialog create() {
            ...
            DialogInterface.OnKeyListener onKeyListener = this.f5P.mOnKeyListener;
    ...
    public static int resolveDialogTheme(@NonNull Context context, @StyleRes int i) {
        ...
        TypedValue typedValue = new TypedValue();
        context.getTheme().resolveAttribute(C0049R.attr.alertDialogTheme, typedValue, true);
