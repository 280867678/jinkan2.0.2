...
public class MenuItemWrapperICS extends BaseMenuWrapper implements MenuItem {
    ...
    public MenuItem setActionView(int i) {
        this.mWrappedObject.mo4266setActionView(i);
        View actionView = this.mWrappedObject.getActionView();
        if (actionView instanceof android.view.CollapsibleActionView) {
            this.mWrappedObject.mo4267setActionView(new CollapsibleActionViewWrapper(actionView));
        }
        return this;
    }
    ...
    public MenuItem setActionView(View view) {
        ...
        this.mWrappedObject.mo4267setActionView(view);
        return this;
    }
    ...
    public MenuItem setContentDescription(CharSequence charSequence) {
        this.mWrappedObject.mo4268setContentDescription(charSequence);
        return this;
    }
    ...
    public MenuItem setShowAsActionFlags(int i) {
        this.mWrappedObject.mo4269setShowAsActionFlags(i);
        return this;
    }
    ...
    public MenuItem setTooltipText(CharSequence charSequence) {
        this.mWrappedObject.mo4270setTooltipText(charSequence);
        return this;
    }
