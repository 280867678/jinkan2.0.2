...
public final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    public static final int ITEM_LAYOUT = C0049R.layout.abc_cascading_menu_item_layout;
    ...
    public CascadingMenuPopup(@NonNull Context context, @NonNull View view, @AttrRes int i, @StyleRes int i2, boolean z) {
        ...
        this.mMenuMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0049R.dimen.abc_config_prefDialogWidth));
    }
    ...
    private View findParentViewForSubmenu(@NonNull CascadingMenuInfo cascadingMenuInfo, @NonNull MenuBuilder menuBuilder) {
        ...
        while (true) {
            if (i2 >= count) {
                i2 = -1;
                break;
            } else if (findMenuItemForSubmenu == menuAdapter.mo4265getItem(i2)) {
                break;
            } else {
                i2++;
            }
    ...
    private void showMenu(@NonNull MenuBuilder menuBuilder) {
        ...
        if (view != null) {
            ...
            if ((this.mDropDownGravity & 5) != 5) {
                ...
                width = i2 - measureIndividualMenuWidth;
                createPopupWindow.setHorizontalOffset(width);
                createPopupWindow.setOverlapAnchor(true);
                createPopupWindow.setVerticalOffset(i);
            } else if (z) {
        ...
        FrameLayout frameLayout = (FrameLayout) from.inflate(C0049R.layout.abc_popup_menu_header_item_layout, (ViewGroup) listView, false);
