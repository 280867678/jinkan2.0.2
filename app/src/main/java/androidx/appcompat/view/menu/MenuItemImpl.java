...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    public String getShortcutLabel() {
        ...
        if (ViewConfiguration.get(this.mMenu.getContext()).hasPermanentMenuKey()) {
            sb.append(resources.getString(C0049R.string.abc_prepend_shortcut_label));
        }
        int i2 = this.mMenu.isQwertyMode() ? this.mShortcutAlphabeticModifiers : this.mShortcutNumericModifiers;
        appendModifier(sb, i2, 65536, resources.getString(C0049R.string.abc_menu_meta_shortcut_label));
        appendModifier(sb, i2, 4096, resources.getString(C0049R.string.abc_menu_ctrl_shortcut_label));
        appendModifier(sb, i2, 2, resources.getString(C0049R.string.abc_menu_alt_shortcut_label));
        appendModifier(sb, i2, 1, resources.getString(C0049R.string.abc_menu_shift_shortcut_label));
        appendModifier(sb, i2, 4, resources.getString(C0049R.string.abc_menu_sym_shortcut_label));
        appendModifier(sb, i2, 8, resources.getString(C0049R.string.abc_menu_function_shortcut_label));
        if (shortcut == '\b') {
            i = C0049R.string.abc_menu_delete_shortcut_label;
        } else if (shortcut == '\n') {
            i = C0049R.string.abc_menu_enter_shortcut_label;
        } else if (shortcut != ' ') {
            sb.append(shortcut);
            return sb.toString();
        } else {
            i = C0049R.string.abc_menu_space_shortcut_label;
        }
    ...
    public SupportMenuItem mo4266setActionView(int i) {
        Context context = this.mMenu.getContext();
        mo4267setActionView(LayoutInflater.from(context).inflate(i, (ViewGroup) new LinearLayout(context), false));
        return this;
    }

    @Override // androidx.core.internal.view.SupportMenuItem, android.view.MenuItem
    /* renamed from: setActionView  reason: collision with other method in class */
    public SupportMenuItem mo4267setActionView(View view) {
        int i;
    ...
    public SupportMenuItem mo4268setContentDescription(CharSequence charSequence) {
    ...
    public SupportMenuItem mo4269setShowAsActionFlags(int i) {
        setShowAsAction(i);
        return this;
    }
    ...
    public SupportMenuItem mo4270setTooltipText(CharSequence charSequence) {
