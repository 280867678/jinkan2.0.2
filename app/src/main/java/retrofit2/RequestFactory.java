...
public final class RequestFactory {
    ...
    public static final class Builder {
        ...
        private ParameterHandler<?> parseParameter(int i, Type type, Annotation[] annotationArr, boolean z) {
            ...
            if (parameterHandler == null) {
                if (z) {
                    try {
                        if (Utils.getRawType(type) == mg0.class) {
        ...
        private ParameterHandler<?> parseParameterAnnotation(int i, Type type, Annotation[] annotationArr, Annotation annotation) {
            if (annotation instanceof Url) {
                ...
                Headers m55of = Headers.m55of("Content-Disposition", outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("form-data; name=\"", value5, "\""), "Content-Transfer-Encoding", part.encoding());
                if (Iterable.class.isAssignableFrom(rawType8)) {
                    if (!(type instanceof ParameterizedType)) {
                        throw Utils.parameterError(this.method, i, rawType8.getSimpleName() + " must include generic type (e.g., " + rawType8.getSimpleName() + "<String>)", new Object[0]);
                    } else {
                        ...
                        return new ParameterHandler.Part(this.method, i, m55of, this.retrofit.requestBodyConverter(parameterUpperBound4, annotationArr, this.methodAnnotations)).iterable();
                    }
                }
                if (!rawType8.isArray()) {
                    ...
                    return new ParameterHandler.Part(this.method, i, m55of, this.retrofit.requestBodyConverter(type, annotationArr, this.methodAnnotations));
                }
                Class<?> boxIfPrimitive = boxIfPrimitive(rawType8.getComponentType());
                if (MultipartBody.Part.class.isAssignableFrom(boxIfPrimitive)) {
                    throw Utils.parameterError(this.method, i, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
                }
                return new ParameterHandler.Part(this.method, i, m55of, this.retrofit.requestBodyConverter(boxIfPrimitive, annotationArr, this.methodAnnotations)).array();
                ...
                for (int i2 = i - 1; i2 >= 0; i2--) {
                    ...
                    if ((parameterHandler instanceof ParameterHandler.Tag) && ((ParameterHandler.Tag) parameterHandler).cls.equals(rawType10)) {
                        ...
                        StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("@Tag type ");
                        Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(rawType10.getName());
                        Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(" is duplicate of parameter #");
                        Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(i2 + 1);
                        Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(" and would always overwrite its value.");
                        throw Utils.parameterError(method, i, Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.toString(), new Object[0]);
                    }
                }
    ...
    public Request create(Object[] objArr) throws IOException {
        ...
        throw new IllegalArgumentException(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Argument count (", length, ") doesn't match expected count ("), parameterHandlerArr.length, ")"));
    }
}
