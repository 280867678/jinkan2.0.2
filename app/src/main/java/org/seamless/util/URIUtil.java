...
public class URIUtil {
    ...
    public static void assertRelativeURI(String str, URI uri) {
        ...
        throw new IllegalArgumentException(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(str, " URI must be relative, without scheme and authority"));
    }
    ...
    public static URL createAbsoluteURL(InetAddress inetAddress, int i, URI uri) throws IllegalArgumentException {
        try {
            if (inetAddress instanceof Inet6Address) {
                ...
                return createAbsoluteURL(new URL(DefaultWebClient.HTTP_SCHEME + inetAddress.getHostAddress() + ":" + i), uri);
            }
        } catch (Exception e) {
