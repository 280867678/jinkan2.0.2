...
/* renamed from: org.seamless.util.io.HexBin */
/* loaded from: classes5.dex */
public final class HexBin {
    public static final int BASELENGTH = 255;
    public static final int LOOKUPLENGTH = 16;
    public static byte[] hexNumberTable = new byte[255];
    public static byte[] lookUpHexAlphabet = new byte[16];
