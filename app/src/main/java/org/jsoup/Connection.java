...
public interface Connection {
    ...
    public interface KeyVal {
        ...
        /* renamed from: inputStream */
        KeyVal mo5231inputStream(InputStream inputStream);

        String key();

        /* renamed from: key */
        KeyVal mo5232key(String str);

        String value();

        /* renamed from: value */
        KeyVal mo5233value(String str);
    }
    ...
    public interface Request extends Base<Request> {
        ...
        /* renamed from: data */
        Request mo5234data(KeyVal keyVal);
        ...
        /* renamed from: parser */
        Request mo5235parser(Parser parser);
        ...
        /* renamed from: proxy */
        Request mo5236proxy(String str, int i);

        /* renamed from: proxy */
        Request mo5237proxy(Proxy proxy);
    ...
    public interface Response extends Base<Response> {
        ...
        Response mo5239charset(String str);
