...
public class Container {
    public static final Logger LOG = Log.getLogger(Container.class);
    public final CopyOnWriteArrayList<Listener> _listeners = new CopyOnWriteArrayList<>();
    ...
    public static class Relationship {
        public final WeakReference<Object> _child;
        public Container _container;
        public final WeakReference<Object> _parent;
