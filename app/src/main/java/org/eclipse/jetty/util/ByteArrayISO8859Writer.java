...
public class ByteArrayISO8859Writer extends Writer {
    ...
    public void ensureSpareCapacity(int i) throws IOException {
        ...
        if (i3 > bArr.length) {
            if (this._fixed) {
                StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Buffer overflow: ");
                Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(this._buf.length);
