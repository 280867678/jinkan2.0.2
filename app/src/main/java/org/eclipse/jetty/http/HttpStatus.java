...
public class HttpStatus {
    ...
    public static final Code[] codeMap = new Code[TbsListener.ErrorCode.INFO_CODE_FILEREADER_OPENFILEREADER_OPENINQB];
    ...
    public static String getMessage(int i) {
        Code code = getCode(i);
        return code != null ? code.getMessage() : Integer.toString(i);
    }
