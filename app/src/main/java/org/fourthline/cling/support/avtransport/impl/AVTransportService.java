...
public class AVTransportService<T extends AVTransport> extends AbstractAVTransportService {
    public static final Logger log = Logger.getLogger(AVTransportService.class.getName());
    ...
    public final Map<Long, AVTransportStateMachine> stateMachines;
    ...
    public void seek(UnsignedIntegerFourBytes unsignedIntegerFourBytes, String str, String str2) throws AVTransportException {
        try {
            ...
            throw new AVTransportException(AVTransportErrorCode.SEEKMODE_NOT_SUPPORTED, outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Unsupported seek mode: ", str));
        }
    }
    ...
    public void setPlayMode(UnsignedIntegerFourBytes unsignedIntegerFourBytes, String str) throws AVTransportException {
        ...
        try {
            ...
            throw new AVTransportException(AVTransportErrorCode.PLAYMODE_NOT_SUPPORTED, outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Unsupported play mode: ", str));
        }
    }
    ...
    public void setRecordQualityMode(UnsignedIntegerFourBytes unsignedIntegerFourBytes, String str) throws AVTransportException {
        ...
        try {
            ...
            throw new AVTransportException(AVTransportErrorCode.RECORDQUALITYMODE_NOT_SUPPORTED, outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Unsupported record quality mode: ", str));
        }
    }
