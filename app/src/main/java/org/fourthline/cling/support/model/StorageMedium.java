...
public enum StorageMedium {
    ...
    public static Map<String, StorageMedium> byProtocolString = new HashMap<String, StorageMedium>() { // from class: org.fourthline.cling.support.model.StorageMedium.1
        {
    ...
    public static StorageMedium valueOrExceptionOf(String str) {
        ...
        throw new IllegalArgumentException(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Invalid storage medium string: ", str));
    }
