...
public class PositionInfo {
    ...
    public UnsignedIntegerFourBytes track;
    ...
    public String toString() {
        StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("(PositionInfo) Track: ");
        Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(getTrack());
        Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(" RelTime: ");
        Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(getRelTime());
        Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(" Duration: ");
        Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(getTrackDuration());
        Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(" Percent: ");
        Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(getElapsedPercent());
