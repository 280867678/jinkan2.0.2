...
@UpnpStateVariables({@UpnpStateVariable(datatype = Main.STRING_TAG_STR, name = "A_ARG_TYPE_ObjectID", sendEvents = false), @UpnpStateVariable(datatype = Main.STRING_TAG_STR, name = "A_ARG_TYPE_Result", sendEvents = false), @UpnpStateVariable(allowedValuesEnum = BrowseFlag.class, datatype = Main.STRING_TAG_STR, name = "A_ARG_TYPE_BrowseFlag", sendEvents = false), @UpnpStateVariable(datatype = Main.STRING_TAG_STR, name = "A_ARG_TYPE_Filter", sendEvents = false), @UpnpStateVariable(datatype = Main.STRING_TAG_STR, name = "A_ARG_TYPE_SortCriteria", sendEvents = false), @UpnpStateVariable(datatype = "ui4", name = "A_ARG_TYPE_Index", sendEvents = false), @UpnpStateVariable(datatype = "ui4", name = "A_ARG_TYPE_Count", sendEvents = false), @UpnpStateVariable(datatype = "ui4", name = "A_ARG_TYPE_UpdateID", sendEvents = false), @UpnpStateVariable(datatype = "uri", name = "A_ARG_TYPE_URI", sendEvents = false), @UpnpStateVariable(datatype = Main.STRING_TAG_STR, name = "A_ARG_TYPE_SearchCriteria", sendEvents = false)})
...
public abstract class AbstractContentDirectoryService {
    ...
    public final CSV<String> searchCapabilities;
    @UpnpStateVariable(sendEvents = false)
    public final CSV<String> sortCapabilities;
