...
public enum DLNAProfiles {
    NONE("", ""),
    JPEG_SM("JPEG_SM", DLNAMimeTypes.MIME_IMAGE_JPEG),
    JPEG_MED("JPEG_MED", DLNAMimeTypes.MIME_IMAGE_JPEG),
    JPEG_LRG("JPEG_LRG", DLNAMimeTypes.MIME_IMAGE_JPEG),
    JPEG_TN("JPEG_TN", DLNAMimeTypes.MIME_IMAGE_JPEG),
    JPEG_SM_ICO("JPEG_SM_ICO", DLNAMimeTypes.MIME_IMAGE_JPEG),
    JPEG_LRG_ICO("JPEG_LRG_ICO", DLNAMimeTypes.MIME_IMAGE_JPEG),
