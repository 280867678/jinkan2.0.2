...
public enum AVTransportErrorCode {
    ...
    PLAYBACK_FORMAT_NOT_SUPPORTED(TbsListener.ErrorCode.INFO_COOKIE_SWITCH_TRANSFER, "The storage format of the currently loaded media is not supported for playback"),
