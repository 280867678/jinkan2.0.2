...
public abstract class Browse extends ActionCallback {
    ...
    public static Logger log = Logger.getLogger(Browse.class.getName());
    ...
    public void success(ActionInvocation actionInvocation) {
        ...
        try {
            ...
            actionInvocation.setFailure(new ActionException(ErrorCode.ACTION_FAILED, outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Can't parse DIDL XML response: ", e), e));
