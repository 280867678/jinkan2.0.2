...
@UpnpStateVariables({@UpnpStateVariable(datatype = Main.STRING_TAG_STR, name = "SourceProtocolInfo"), @UpnpStateVariable(datatype = Main.STRING_TAG_STR, name = "SinkProtocolInfo"), @UpnpStateVariable(datatype = Main.STRING_TAG_STR, name = "CurrentConnectionIDs"), @UpnpStateVariable(allowedValuesEnum = ConnectionInfo.Status.class, name = "A_ARG_TYPE_ConnectionStatus", sendEvents = false), @UpnpStateVariable(datatype = Main.STRING_TAG_STR, name = "A_ARG_TYPE_ConnectionManager", sendEvents = false), @UpnpStateVariable(allowedValuesEnum = ConnectionInfo.Direction.class, name = "A_ARG_TYPE_Direction", sendEvents = false), @UpnpStateVariable(datatype = Main.STRING_TAG_STR, name = "A_ARG_TYPE_ProtocolInfo", sendEvents = false), @UpnpStateVariable(datatype = "i4", name = "A_ARG_TYPE_ConnectionID", sendEvents = false), @UpnpStateVariable(datatype = "i4", name = "A_ARG_TYPE_AVTransportID", sendEvents = false), @UpnpStateVariable(datatype = "i4", name = "A_ARG_TYPE_RcsID", sendEvents = false)})
/* loaded from: classes5.dex */
public class ConnectionManagerService {
    public static final Logger log = Logger.getLogger(ConnectionManagerService.class.getName());
    public final Map<Integer, ConnectionInfo> activeConnections;
    public final PropertyChangeSupport propertyChangeSupport;
    public final ProtocolInfos sinkProtocolInfo;
    public final ProtocolInfos sourceProtocolInfo;
