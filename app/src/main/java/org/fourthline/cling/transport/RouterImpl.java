...
public class RouterImpl implements Router {
    public static Logger log = Logger.getLogger(Router.class.getName());
    ...
    public final Map<NetworkInterface, MulticastReceiver> multicastReceivers = new HashMap();
    public final Map<InetAddress, DatagramIO> datagramIOs = new HashMap();
    public final Map<InetAddress, StreamServer> streamServers = new HashMap();
    ...
    public RouterImpl(UpnpServiceConfiguration upnpServiceConfiguration, ProtocolFactory protocolFactory) {
        ...
        this.writeLock = this.routerLock.writeLock();
        Logger logger = log;
        StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Creating Router: ");
    ...
    public void handleStartFailure(InitializationException initializationException) throws InitializationException {
        ...
        Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(Exceptions.unwrap(initializationException));
        logger2.severe(Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.toString());
    }
    ...
    public void lock(Lock lock, int i) throws RouterException {
        try {
            ...
            StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Interruption while waiting for exclusive access: ");
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(lock.getClass().getSimpleName());
            throw new RouterException(Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.toString(), e);
        }
    }
    ...
    public void received(IncomingDatagramMessage incomingDatagramMessage) {
        ...
        try {
            ...
            Logger logger4 = log;
            StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Handling received datagram failed - ");
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(Exceptions.unwrap(e).toString());
    ...
    public void startAddressBasedTransports(Iterator<InetAddress> it) throws InitializationException {
        ...
        for (Map.Entry<InetAddress, StreamServer> entry : this.streamServers.entrySet()) {
            if (log.isLoggable(Level.FINE)) {
                Logger logger7 = log;
                StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Starting stream server on address: ");
                Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(entry.getKey());
                logger7.fine(Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.toString());
            }
        ...
        for (Map.Entry<InetAddress, DatagramIO> entry2 : this.datagramIOs.entrySet()) {
            if (log.isLoggable(Level.FINE)) {
                Logger logger8 = log;
                StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2 = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Starting datagram I/O on address: ");
                Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2.append(entry2.getKey());
                logger8.fine(Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2.toString());
            }
    ...
    public void startInterfaceBasedTransports(Iterator<NetworkInterface> it) throws InitializationException {
        ...
        for (Map.Entry<NetworkInterface, MulticastReceiver> entry : this.multicastReceivers.entrySet()) {
            if (log.isLoggable(Level.FINE)) {
                Logger logger3 = log;
                StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Starting multicast receiver on interface: ");
                Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(entry.getKey().getDisplayName());
    ...
    public void unlock(Lock lock) {
        Logger logger = log;
        StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Releasing router lock: ");
        Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(lock.getClass().getSimpleName());
