...
public class Namespace {
    ...
    public String getDevicePath(Device device) {
        if (device.getIdentity().getUdn() != null) {
            StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(DEVICE, "/");
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(URIUtil.encodePathSegment(device.getIdentity().getUdn().getIdentifierString()));
    ...
    public String getServicePath(Service service) {
        if (service.getServiceId() != null) {
            StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(SERVICE, "/");
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(service.getServiceId().getNamespace());
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append("/");
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(service.getServiceId().getId());
            return getDevicePath(service.getDevice()) + Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.toString();
        }
