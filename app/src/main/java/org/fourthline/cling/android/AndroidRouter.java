...
public class AndroidRouter extends RouterImpl {
    ...
    public class ConnectivityBroadcastReceiver extends BroadcastReceiver {
        ...
        public void displayIntentInfo(Intent intent) {
            ...
            StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("EXTRA_NETWORK_INFO: ");
            if (networkInfo == null) {
                networkInfo = Constants.CP_NONE;
            }
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(networkInfo);
            logger4.info(Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.toString());
            Logger logger5 = AndroidRouter.log;
            StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2 = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("EXTRA_OTHER_NETWORK_INFO: ");
            if (networkInfo2 == null) {
                networkInfo2 = Constants.CP_NONE;
            }
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2.append(networkInfo2);
            logger5.info(Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2.toString());
            Logger logger6 = AndroidRouter.log;
            StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww3 = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("EXTRA_EXTRA_INFO: ");
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww3.append(intent.getStringExtra("extraInfo"));
            logger6.info(Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww3.toString());
        }
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            try {
                AndroidRouter.this.onNetworkTypeChange(AndroidRouter.this.networkInfo, connectedNetworkInfo);
    ...
    public void setWiFiMulticastLock(boolean z) {
        ...
        if (this.multicastLock == null) {
            this.multicastLock = this.wifiManager.createMulticastLock(AndroidRouter.class.getSimpleName());
        }
        if (z) {
    ...
    public void setWifiLock(boolean z) {
        ...
        if (this.wifiLock == null) {
            this.wifiLock = this.wifiManager.createWifiLock(3, AndroidRouter.class.getSimpleName());
        }
        if (z) {
