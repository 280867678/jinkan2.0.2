...
public class MutableStateVariable {
    ...
    public StateVariable build() {
        ...
        if (this.allowedValueRange != null) {
            stateVariableAllowedValueRange = new StateVariableAllowedValueRange(this.allowedValueRange.minimum.longValue(), this.allowedValueRange.maximum.longValue(), this.allowedValueRange.step.longValue());
        }
