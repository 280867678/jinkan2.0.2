...
public class MutableService {
    ...
    public Service build(Device device) throws ValidationException {
        return device.mo5198newInstance(this.serviceType, this.serviceId, this.descriptorURI, this.controlURI, this.eventSubscriptionURI, createActions(), createStateVariables());
    }
