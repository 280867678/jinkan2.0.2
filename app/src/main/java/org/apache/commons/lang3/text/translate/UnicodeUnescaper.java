    ...
    public int translate(CharSequence charSequence, int i, Writer writer) throws IOException {
        ...
        if (charSequence.charAt(i) == '\\' && (i2 = i + 1) < charSequence.length() && charSequence.charAt(i2) == 'u') {
            ...
            if (i6 > charSequence.length()) {
                StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Less than 4 hex digits in unicode value: '");
                Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append((Object) charSequence.subSequence(i, charSequence.length()));
                Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append("' due to end of CharSequence");
