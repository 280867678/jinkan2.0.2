...
public class EntityArrays {
    ...
    public static final String[][] APOS_UNESCAPE;
    public static final String[][] BASIC_ESCAPE;
    public static final String[][] BASIC_UNESCAPE;
    public static final String[][] HTML40_EXTENDED_ESCAPE;
    public static final String[][] HTML40_EXTENDED_UNESCAPE;
    public static final String[][] ISO8859_1_ESCAPE;
    public static final String[][] ISO8859_1_UNESCAPE;
    public static final String[][] JAVA_CTRL_CHARS_ESCAPE;
    public static final String[][] JAVA_CTRL_CHARS_UNESCAPE;
    ...
    static {
        ...
        String[][] strArr5 = {new String[]{"\b", "\\b"}, new String[]{"\n", "\\n"}, new String[]{"\t", "\\t"}, new String[]{"\f", "\\f"}, new String[]{StringUtils.f4552CR, "\\r"}};
