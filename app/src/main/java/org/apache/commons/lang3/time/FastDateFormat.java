...
public class FastDateFormat extends Format implements DateParser, DatePrinter {
    ...
    public String toString() {
        StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("FastDateFormat[");
        Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(this.printer.getPattern());
        Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(",");
        Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(this.printer.getLocale());
        Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(",");
        Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(this.printer.getTimeZone().getID());
        Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append("]");
