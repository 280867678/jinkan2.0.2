...
public class ConstructorUtils {
    ...
    public static <T> T invokeConstructor(Class<T> cls, Object[] objArr, Class<?>[] clsArr) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
        ...
        StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("No such accessible constructor on object: ");
        Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(cls.getName());
        throw new NoSuchMethodException(Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.toString());
    }
