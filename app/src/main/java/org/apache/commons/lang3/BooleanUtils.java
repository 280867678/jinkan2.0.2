...
public class BooleanUtils {
    ...
    /* renamed from: or */
    public static Boolean m48or(Boolean... boolArr) {
        if (boolArr != null) {
            if (boolArr.length == 0) {
                throw new IllegalArgumentException("Array is empty");
            }
            try {
                return m47or(ArrayUtils.toPrimitive(boolArr)) ? Boolean.TRUE : Boolean.FALSE;
            } catch (NullPointerException unused) {
                throw new IllegalArgumentException("The array must not contain any null elements");
            }
        }
    ...
    /* renamed from: or */
    public static boolean m47or(boolean... zArr) {
        if (zArr != null) {
            if (zArr.length == 0) {
                throw new IllegalArgumentException("Array is empty");
            }
