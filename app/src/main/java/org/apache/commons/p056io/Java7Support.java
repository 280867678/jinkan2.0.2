...
/* renamed from: org.apache.commons.io.Java7Support */
...
public class Java7Support {
    ...
    static {
        ...
        try {
            ...
            emptyFileAttributes = newInstance;
            createSymlink = loadClass.getMethod("createSymbolicLink", loadClass2, loadClass2, newInstance.getClass());
            Object newInstance2 = Array.newInstance(loadClass4, 0);
            emptyLinkOpts = newInstance2;
            exists = loadClass.getMethod("exists", loadClass2, newInstance2.getClass());
