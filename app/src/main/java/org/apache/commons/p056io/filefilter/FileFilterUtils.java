...
public class FileFilterUtils {
    public static final IOFileFilter cvsFilter = notFileFilter(and(directoryFileFilter(), nameFileFilter("CVS")));
    public static final IOFileFilter svnFilter = notFileFilter(and(directoryFileFilter(), nameFileFilter(".svn")));
    ...
    public static <T extends Collection<File>> T filter(IOFileFilter iOFileFilter, Iterable<File> iterable, T t) {
    ...
    /* renamed from: or */
    public static IOFileFilter m49or(IOFileFilter... iOFileFilterArr) {
        ...
        if (iOFileFilterArr != null) {
            ...
            for (int i = 0; i < iOFileFilterArr.length; i++) {
                if (iOFileFilterArr[i] == null) {
                    throw new IllegalArgumentException(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("The filter[", i, "] is null"));
                }
