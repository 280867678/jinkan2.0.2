...
public class BasicLineParser implements LineParser {
    ...
    public boolean hasProtocolVersion(CharArrayBuffer charArrayBuffer, ParserCursor parserCursor) {
        ...
        for (int i2 = 0; z2 && i2 < length; i2++) {
            z2 = charArrayBuffer.charAt(pos + i2) == protocol.charAt(i2);
        }
        if (!z2) {
            return z2;
        }
    ...
    public ProtocolVersion parseProtocolVersion(CharArrayBuffer charArrayBuffer, ParserCursor parserCursor) throws ParseException {
        ...
        int i = pos2 + length;
        if (i + 4 > upperBound) {
            StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Not a valid protocol version: ");
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(charArrayBuffer.substring(pos, upperBound));
        ...
        if (!z2) {
            StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2 = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Not a valid protocol version: ");
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2.append(charArrayBuffer.substring(pos, upperBound));
        ...
        if (indexOf == -1) {
            StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww3 = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Invalid protocol version number: ");
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww3.append(charArrayBuffer.substring(pos, upperBound));
            throw new ParseException(Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww3.toString());
        }
        try {
            ...
            try {
                ...
                StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww4 = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Invalid protocol minor version number: ");
                Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww4.append(charArrayBuffer.substring(pos, upperBound));
                throw new ParseException(Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww4.toString());
            }
        } catch (NumberFormatException unused2) {
            StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww5 = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Invalid protocol major version number: ");
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww5.append(charArrayBuffer.substring(pos, upperBound));
            throw new ParseException(Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww5.toString());
        }
    }
    ...
    public RequestLine parseRequestLine(CharArrayBuffer charArrayBuffer, ParserCursor parserCursor) throws ParseException {
        ...
        try {
            ...
            StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Invalid request line: ");
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(charArrayBuffer.substring(pos, upperBound));
            throw new ParseException(Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.toString());
        }
    }
    ...
    public StatusLine parseStatusLine(CharArrayBuffer charArrayBuffer, ParserCursor parserCursor) throws ParseException {
        ...
        try {
            ...
            StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Invalid status line: ");
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(charArrayBuffer.substring(pos, upperBound));
            throw new ParseException(Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.toString());
        }
    }
