    ...
    public HttpResponse doReceiveResponse(HttpRequest httpRequest, HttpClientConnection httpClientConnection, HttpContext httpContext) throws HttpException, IOException {
        ...
        while (true) {
            if (httpResponse == null || i < 200) {
                ...
                if (i < 100) {
                    StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Invalid response: ");
                    Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(httpResponse.getStatusLine());
            ...
            if (httpEntityEnclosingRequest.expectContinue() && !protocolVersion.lessEquals(HttpVersion.HTTP_1_0)) {
                ...
                if (httpClientConnection.isResponseAvailable(this.waitForContinue)) {
                    ...
                    if (statusCode >= 200) {
                        ...
                        StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Unexpected response: ");
                        Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(receiveResponseHeader.getStatusLine());
                        throw new ProtocolException(Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.toString());
                    }
                }
            }
