...
public final class HttpHost implements Cloneable, Serializable {
    ...
    public HttpHost(String str, int i, String str2) {
        ...
        this.schemeName = str2 != null ? str2.toLowerCase(Locale.ROOT) : "http";
        this.port = i;
        this.address = null;
    }
    ...
    public static HttpHost create(String str) {
        ...
        if (lastIndexOf > 0) {
            try {
                ...
                throw new IllegalArgumentException(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Invalid HTTP host: ", str));
            }
        }
