...
public final class ContentType implements Serializable {
    ...
    public static final ContentType IMAGE_JPEG = create(DLNAProfiles.DLNAMimeTypes.MIME_IMAGE_JPEG);
    public static final ContentType IMAGE_PNG = create(DLNAProfiles.DLNAMimeTypes.MIME_IMAGE_PNG);
    ...
    public static ContentType parse(String str) throws ParseException, UnsupportedCharsetException {
        ...
        throw new ParseException(outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Invalid content type: ", str));
    }
