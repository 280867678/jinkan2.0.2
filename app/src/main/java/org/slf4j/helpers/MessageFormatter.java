...
public final class MessageFormatter {
    ...
    public static void booleanArrayAppend(StringBuilder sb, boolean[] zArr) {
        sb.append('[');
    ...
    public static void byteArrayAppend(StringBuilder sb, byte[] bArr) {
        sb.append('[');
    ...
    public static void charArrayAppend(StringBuilder sb, char[] cArr) {
        sb.append('[');
    ...
    public static void doubleArrayAppend(StringBuilder sb, double[] dArr) {
        sb.append('[');
    ...
    public static void floatArrayAppend(StringBuilder sb, float[] fArr) {
        sb.append('[');
    ...
    public static void intArrayAppend(StringBuilder sb, int[] iArr) {
        sb.append('[');
    ...
    public static void longArrayAppend(StringBuilder sb, long[] jArr) {
        sb.append('[');
    ...
    public static void objectArrayAppend(StringBuilder sb, Object[] objArr, Map<Object[], Object> map) {
        sb.append('[');
    ...
    public static void safeObjectAppend(StringBuilder sb, Object obj) {
        try {
            ...
            StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("SLF4J: Failed toString() invocation on an object of type [");
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(obj.getClass().getName());
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append("]");
            Util.report(Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.toString(), th);
            sb.append("[FAILED toString()]");
        }
    }

    public static void shortArrayAppend(StringBuilder sb, short[] sArr) {
        sb.append('[');
