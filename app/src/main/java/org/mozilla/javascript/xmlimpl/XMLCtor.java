...
public class XMLCtor extends IdFunctionObject {
    public static final int Id_defaultSettings = 1;
    public static final int Id_ignoreComments = 1;
    public static final int Id_ignoreProcessingInstructions = 2;
    public static final int Id_ignoreWhitespace = 3;
    public static final int Id_prettyIndent = 4;
    public static final int Id_prettyPrinting = 5;
    public static final int Id_setSettings = 3;
    public static final int Id_settings = 2;
    public static final int MAX_FUNCTION_ID = 3;
    public static final int MAX_INSTANCE_ID = 5;
    public static final Object XMLCTOR_TAG = "XMLCtor";
    public static final long serialVersionUID = -8708195078359817341L;
    public XmlProcessor options;
