...
public class Main {
    ...
    public ClassCompiler compiler;
    public CompilerEnvirons compilerEnv;
    public String destinationDir;
    public boolean printHelp;
    public ToolErrorReporter reporter = new ToolErrorReporter(true);
    ...
    public static void badUsage(String str) {
    ...
    /* renamed from: p */
    public static void m16p(String str) {
    ...
    public String[] processOptions(String[] strArr) {
        ...
        m16p(ToolErrorReporter.getMessage("msg.no.file"));
        return null;
    }
    ...
    public void processSource(String[] strArr) {
        for (int i = 0; i != strArr.length; i++) {
            ...
            if (this.targetPackage.length() != 0) {
                str2 = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(new StringBuilder(), this.targetPackage, ".", str2);
            }
