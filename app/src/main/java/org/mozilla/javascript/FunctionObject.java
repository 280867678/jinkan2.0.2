...
public class FunctionObject extends BaseFunction {
    ...
    public static final short VARARGS_CTOR = -2;
    public static final short VARARGS_METHOD = -1;
    public static boolean sawSecurityException = false;
    ...
    */
    public Object call(Context context, Scriptable scriptable, Scriptable scriptable2, Object[] objArr) {
        ...
        if (i2 >= 0) {
            ...
            z2 = true;
            return !z2 ? this.hasVoidReturn ? Undefined.instance : this.returnTypeTag == 0 ? context.getWrapFactory().wrap(context, scriptable, newInstance, null) : newInstance : newInstance;
        } else {
