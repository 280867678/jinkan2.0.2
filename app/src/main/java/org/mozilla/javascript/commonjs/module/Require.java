...
public class Require extends BaseFunction {
    public static final ThreadLocal<Map<String, Scriptable>> loadingModuleInterfaces = new ThreadLocal<>();
    public static final long serialVersionUID = 1;
    public Scriptable mainExports;
    public final ModuleScriptProvider moduleScriptProvider;
    public final Scriptable nativeScope;
    public final Scriptable paths;
    public final Script postExec;
    public final Script preExec;
    public final boolean sandboxed;
    public String mainModuleId = null;
    public final Map<String, Scriptable> exportedModuleInterfaces = new ConcurrentHashMap();
    ...
    private Scriptable executeModuleScript(Context context, String str, Scriptable scriptable, ModuleScript moduleScript, boolean z) {
        ...
        moduleScope.put(C1543ak.f3034e, moduleScope, scriptableObject);
    ...
    public Scriptable requireMain(Context context, String str) {
        ...
        if (str2 != null) {
            ...
            StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Main module already set to ");
            Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(this.mainModuleId);
        ...
        try {
            ...
            uri = null;
            uri3 = null;
            this.mainExports = getExportedModuleInterface(context, uri2, uri, uri3, true);
            this.mainModuleId = str;
            return this.mainExports;
        } catch (RuntimeException e) {
            throw e;
