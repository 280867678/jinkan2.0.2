...
public class CachedPowers {
    ...
    public static class CachedPower {
        ...
        public CachedPower(long j, short s, short s2) {
            this.significand = j;
    ...
    public static int getCachedPower(int i, int i2, int i3, DiyFp diyFp) {
        CachedPower cachedPower = CACHED_POWERS[(((((int) Math.ceil((((i2 - i) + 64) - 1) * 0.30102999566398114d)) + 308) - 1) / 8) + 1];
