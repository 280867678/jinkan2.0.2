...
public final class IRFactory extends Parser {
    ...
    private Node arrayCompTransformHelper(ArrayComprehension arrayComprehension, String str) {
        ...
        for (int i = 0; i < size; i++) {
            ArrayComprehensionLoop arrayComprehensionLoop = loops.get(i);
            this.decompiler.addName(StringUtils.SPACE);
        ...
        Node node2 = new Node((int) Token.EXPR_VOID, createCallOrNew, lineno);
        ...
        while (i2 >= 0) {
            try {
                ...
                try {
                    ...
                    node3 = createForIn(154, createLoopNode, nodeArr[i2], nodeArr2[i2], node3, arrayComprehensionLoop2.isForEach(), arrayComprehensionLoop2.isForOf());
                    i2--;
    ...
    private Node createAssignment(int i, Node node, Node node2) {
        ...
        if (type == 33 || type == 36) {
            return new Node(type == 33 ? 140 : 141, makeReference.getFirstChild(), makeReference.getLastChild(), new Node(i2, new Node(Token.USE_STACK), node2));
        } else if (type == 39) {
            ...
            return new Node(143, firstChild, new Node(i2, new Node(Token.USE_STACK), node2));
        }
    }
        ...
        if (i == 105) {
            ...
            switch (i) {
                ...
                case 22:
                    ...
                    } else if (node2.type == 40 && node2.getDouble() == RoundRectDrawableWithShadow.COS_45) {
                ...
                case 23:
                    if (node.type == 40) {
                        ...
                        if (node2.type == 40) {
                            node.setDouble(node2.getDouble() * d2);
                            return node;
                        } else if (d2 == 1.0d) {
    ...
    */
    private Node createForIn(int i, Node node, Node node2, Node node3, Node node4, boolean z, boolean z2) {
        ...
        if (type2 != 123 && type2 != 154) {
            if (type2 == 66 || type2 == 67) {
                if (node2 instanceof ArrayLiteral) {
                    i2 = ((ArrayLiteral) node2).getDestructuringLength();
                }
                type = type2;
                node5 = node2;
                ...
                node10.addChildToBack(new Node((int) Token.EXPR_VOID, simpleAssignment));
            ...
            node102.addChildToBack(new Node((int) Token.EXPR_VOID, simpleAssignment));
        ...
        if (type != 66 && type != 67) {
            ...
            node1022.addChildToBack(new Node((int) Token.EXPR_VOID, simpleAssignment));
        ...
        if (lastChild instanceof ArrayLiteral) {
            i2 = ((ArrayLiteral) lastChild).getDestructuringLength();
        }
        node5 = lastChild;
        type2 = type;
        ...
        if (type2 == -1) {
            ...
            if (!z && !z2 && (type2 == 67 || i2 != 2)) {
                reportError("msg.bad.for.in.destruct");
            }
        } else {
            simpleAssignment = simpleAssignment(node5, node9222);
        }
        node10222.addChildToBack(new Node((int) Token.EXPR_VOID, simpleAssignment));
    ...
    private Scope createLoopNode(Node node, int i) {
        Scope createScopeNode = createScopeNode(Token.LOOP, i);
        if (node != null) {
    ...
    private Node createUnary(int i, Node node) {
        ...
        switch (i) {
            ...
            case 32:
                if (type == 39) {
                    node.mo5274setType(Token.TYPEOFNAME);
                    return node;
                }
                break;
        }
    ...
    private Node genExprTransformHelper(GeneratorExpression generatorExpression) {
        ...
        while (i5 >= 0) {
            ...
            try {
                node2 = createForIn(154, createLoopNode, nodeArr[i5], nodeArr2[i5], node2, generatorExpressionLoop.isForEach(), generatorExpressionLoop.isForOf());
                i5--;
                i6 = i;
            } catch (Throwable th2) {
                th = th2;
    ...
    public static int isAlwaysDefinedBoolean(Node node) {
        ...
        if (type == 40) {
            double d = node.getDouble();
            return (d != d || d == RoundRectDrawableWithShadow.COS_45) ? -1 : 1;
    ...
    /* JADX WARN: Type inference failed for: r3v0, types: [org.mozilla.javascript.IRFactory, org.mozilla.javascript.Parser] */
    ...
    private Node transformDoLoop(DoLoop doLoop) {
        doLoop.mo5274setType(Token.LOOP);
        pushScope(doLoop);
        try {
    ...
    private Node transformForInLoop(ForInLoop forInLoop) {
        ...
        this.decompiler.addToken(88);
        forInLoop.mo5274setType(Token.LOOP);
        pushScope(forInLoop);
        try {
    ...
    private Node transformForLoop(ForLoop forLoop) {
        this.decompiler.addToken(120);
        this.decompiler.addToken(88);
        forLoop.mo5274setType(Token.LOOP);
    ...
    */
    ...
    private Node transformWhileLoop(WhileLoop whileLoop) {
        this.decompiler.addToken(118);
        whileLoop.mo5274setType(Token.LOOP);
        pushScope(whileLoop);
        try {
            this.decompiler.addToken(88);
            ...
            if (type == 66) {
                ...
                switch (type) {
                    ...
                    case 41:
                        ...
                        return;
                    default:
                        StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("unexpected token: ");
                        Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.append(Token.typeToName(astNode.getType()));
                        Kit.codeBug(Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.toString());
                        return;
                }
            }
        }
