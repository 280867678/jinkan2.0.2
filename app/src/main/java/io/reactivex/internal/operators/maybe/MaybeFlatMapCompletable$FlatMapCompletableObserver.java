...
public final class MaybeFlatMapCompletable$FlatMapCompletableObserver<T> extends AtomicReference<p60> implements a60<T>, u50, p60 {
    public static final long serialVersionUID = -2177128922851101253L;
    public final u50 actual;
    public final f70<? super T, ? extends v50> mapper;

    public MaybeFlatMapCompletable$FlatMapCompletableObserver(u50 u50Var, f70<? super T, ? extends v50> f70Var) {
        this.actual = u50Var;
        this.mapper = f70Var;
    }
