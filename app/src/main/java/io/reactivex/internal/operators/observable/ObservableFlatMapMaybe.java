...
public final class ObservableFlatMapMaybe<T, R> extends x80<T, R> {
    public final boolean Wwwwwwwwwwwwwwwwwwwwww;
    public final f70<? super T, ? extends b60<? extends R>> Wwwwwwwwwwwwwwwwwwwwwww;

    /* loaded from: classes4.dex */
    public static final class FlatMapMaybeObserver<T, R> extends AtomicInteger implements j60<T>, p60 {
        ...
        /* loaded from: classes4.dex */
        public final class InnerObserver extends AtomicReference<p60> implements a60<R>, p60 {
        ...
        public FlatMapMaybeObserver(j60<? super R> j60Var, f70<? super T, ? extends b60<? extends R>> f70Var, boolean z) {
            this.actual = j60Var;
            this.mapper = f70Var;
            this.delayErrors = z;
        }
        ...
        public void onNext(T t) {
            try {
                ...
                b60<? extends R> b60Var = apply;
                this.active.getAndIncrement();
                InnerObserver innerObserver = new InnerObserver();
                this.set.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(innerObserver);
                b60Var.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(innerObserver);
            } catch (Throwable th) {
        ...
        @Override // me.tvspark.j60
        public void onSubscribe(p60 p60Var) {
            if (DisposableHelper.validate(this.f4431d, p60Var)) {
                this.f4431d = p60Var;
    ...
    public ObservableFlatMapMaybe(h60<T> h60Var, f70<? super T, ? extends b60<? extends R>> f70Var, boolean z) {
        super(h60Var);
    ...
    public void subscribeActual(j60<? super R> j60Var) {
        this.Wwwwwwwwwwwwwwwwwwwwwwww.subscribe(new FlatMapMaybeObserver(j60Var, this.Wwwwwwwwwwwwwwwwwwwwwww, this.Wwwwwwwwwwwwwwwwwwwwww));
    }
}
