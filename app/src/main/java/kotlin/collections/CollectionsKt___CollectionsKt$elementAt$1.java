...
public final class CollectionsKt___CollectionsKt$elementAt$1 extends Lambda implements ih0<Integer, T> {
    ...
    public final T invoke(int i) {
        StringBuilder Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outline.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("Collection doesn't contain element at index ");
